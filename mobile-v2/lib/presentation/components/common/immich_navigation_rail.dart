...
class ImNavigationRail extends StatefulWidget {
  ...
  @override
  State<ImNavigationRail> createState() => _ImNavigationRailState();
}

class _ImNavigationRailState extends State<ImNavigationRail>
  ...
  @override
  void didUpdateWidget(ImNavigationRail oldWidget) {
...
class _AddIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(alignment: Alignment.center, children: [indicator, child]);
  }
}
