          ...
          if (constraints.maxWidth > 600) {
            ...
            return Column(
              ...
              children: [
                ...
                ExifPeople(asset: asset, padding: EdgeInsets.symmetric(horizontal: horizontalPadding,)),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: horizontalPadding,),
                  child: Row(
          ...
          return Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: ExifPeople(asset: asset, padding: EdgeInsets.symmetric(horizontal: horizontalPadding,),),
              ),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: horizontalPadding),
                child: Column(
