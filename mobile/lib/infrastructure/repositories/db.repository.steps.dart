...
final class Schema31 extends i0.VersionedSchema {
  ...
  late final Shape52 offlineAlbumEntity = Shape52(
    source: i0.VersionedTable(
      entityName: 'offline_album_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(album_id)'],
      columns: [_column_177, _column_114],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape53 offlineAssetEntity = Shape53(
    source: i0.VersionedTable(
      entityName: 'offline_asset_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id)'],
      columns: [
...
class Shape53 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get thumbFileName =>
      columnsByName['thumb_file_name']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get fileSize =>
      columnsByName['file_size']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get createdAt =>
      columnsByName['created_at']! as i1.GeneratedColumn<String>;
