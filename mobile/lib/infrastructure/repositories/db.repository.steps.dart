...
final class Schema25 extends i0.VersionedSchema {
  ...
  late final Shape49 visibleStackRepresentative = Shape49(
    source: i0.VersionedView(
      entityName: 'visible_stack_representative',
      createViewStmt:
      ...
      columns: [_column_210, _column_211, _column_212],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  final i1.Index idxRemoteAssetVisibleStack = i1.Index(
...
class Shape49 extends i0.VersionedView {
