...
final class Schema5 extends i0.VersionedSchema {
  ...
  final i1.Index idxLocalAssetChecksum = i1.Index('idx_local_asset_checksum',
      'CREATE INDEX idx_local_asset_checksum ON local_asset_entity (checksum)');
  final i1.Index uQAssetsOwnerChecksum = i1.Index('UQ_assets_owner_checksum',
  ...
  final i1.Index uQAssetsOwnerLibraryChecksum = i1.Index(
...
i1.GeneratedColumn<String> _column_84(String aliasedName) =>
    i1.GeneratedColumn<String>('library_id', aliasedName, true,
        type: i1.DriftSqlType.string);
