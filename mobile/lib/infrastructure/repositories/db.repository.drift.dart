...
abstract class $Drift extends i0.GeneratedDatabase {
  ...
  late final i8.$RemoteAlbumEntityTable remoteAlbumEntity =
      i8.$RemoteAlbumEntityTable(this);
...
class $DriftManager {
  ...
  i9.$$RemoteAlbumAssetEntityTableTableManager get remoteAlbumAssetEntity =>
      i9.$$RemoteAlbumAssetEntityTableTableManager(
