      ...
      await m.runMigrationSteps(
        ...
        steps: migrationSteps(
          ...
          from19To20: (m, v20) async {
            await m.addColumn(v20.remoteExifEntity, v20.remoteExifEntity.fps);
            await m.addColumn(v20.remoteExifEntity, v20.remoteExifEntity.bitRate);
            await m.addColumn(v20.remoteExifEntity, v20.remoteExifEntity.codec);
          },
        ),
      );
