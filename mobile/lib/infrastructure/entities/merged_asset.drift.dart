  ...
  i0.Selectable<MergedAssetResult> mergedAsset({
    ...
    return customSelect(
      ...
      (i0.QueryRow row) => MergedAssetResult(
        ...
        playbackStyle: i0.NullAwareTypeConverter.wrapFromSql(
          i3.$LocalAssetEntityTable.$converterplaybackStyle,
          row.readNullable<int>('playback_style'),
        ),
      ),
    );
  }
