...
class AppRouter extends RootStackRouter {
  ...
  late final List<AutoRoute> routes = [
    ...
    AutoRoute(page: DynamicWallpaperSettingsRoute.page, guards: [_duplicateGuard]),
    ...
    AutoRoute(page: DynamicWallpaperAssetSelectionTimelineRoute.page, guards: [_authGuard, _duplicateGuard]),
