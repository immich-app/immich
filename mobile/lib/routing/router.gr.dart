...
class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    AppearanceRoute.name: (routeData) {
      return MaterialPageX<dynamic>(
          routeData: routeData, child: const AppearancePage());
    },
  ...
  List<RouteConfig> get routes => [
        ...
        RouteConfig(AppearanceRoute.name,
            path: '/appearance-page', guards: [authGuard])
      ];
}
...
class AppearanceRoute extends PageRouteInfo<void> {
  const AppearanceRoute()
      : super(AppearanceRoute.name, path: '/appearance-page');
