...
class AppConfig {
  ...
  T read<T>(SettingsKey<T> key) =>
      (switch (key) {
            ...
            .backupAllowMeteredVpnForVideos => backup.allowMeteredVpnForVideos,
            .backupUseCellularForPhotos => backup.useCellularForPhotos,
            .backupAllowMeteredVpnForPhotos => backup.allowMeteredVpnForPhotos,
  ...
  AppConfig write<T, U extends T>(SettingsKey<T> key, U value) {
    return switch (key) {
      ...
      .backupAllowMeteredVpnForVideos => copyWith(backup: backup.copyWith(allowMeteredVpnForVideos: value as bool)),
      .backupUseCellularForPhotos => copyWith(backup: backup.copyWith(useCellularForPhotos: value as bool)),
      .backupAllowMeteredVpnForPhotos => copyWith(backup: backup.copyWith(allowMeteredVpnForPhotos: value as bool)),
