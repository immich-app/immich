...
class TimelineFactory {
  ...
  TimelineService people(String userId, List<String> personIds) =>
      TimelineService(_timelineRepository.people(userId, personIds.toSet().toList(growable: false), groupBy));
