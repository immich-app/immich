...
class HttpSSLOptions {
  ...
  static Future<void> _apply(bool allowSelfSignedSSLCert, {bool applyNative = true}) async {
    ...
    // on other platforms.
    final androidUserPemCertsByName =
        Platform.isAndroid ? await UserCertificatesApi().getUserPemCertificatesByName() : null;

    HttpOverrides.global =
        HttpSSLCertOverride(allowSelfSignedSSLCert, serverHost, clientCert, androidUserPemCertsByName);
