    ...
    return ProviderScope(
      ...
      child: Timeline(
        appBar: RemoteAlbumSliverAppBar(
          ...
          kebabMenu: _buildKebabMenu(context, isOwner),
          onToggleAlbumOrder: isOwner ? () => toggleAlbumOrder() : null,
