...
class AddActionButton extends ConsumerWidget {
  ...
  Future<void> _showAddOptions(BuildContext context, WidgetRef ref) async {
    ...
    final List<PopupMenuEntry<AddToMenuItem>> items = [
      PopupMenuItem(enabled: false, textStyle: context.textTheme.labelMedium, height: 40, child: const Text("Add to")),
      PopupMenuItem(
      ...
      PopupMenuItem(enabled: false, textStyle: context.textTheme.labelMedium, height: 40, child: const Text("Move to")),
      if (isOwner) ...[
        if (showArchive)
          PopupMenuItem(
            height: menuItemHeight,
