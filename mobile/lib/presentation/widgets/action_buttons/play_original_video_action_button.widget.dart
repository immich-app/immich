...
class PlayOriginalVideoActionButton extends ConsumerWidget {
  const PlayOriginalVideoActionButton({
    super.key,
    required this.asset,
    this.iconOnly = false,
    this.menuItem = false,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final playOriginalVideo = ref.watch(playOriginalVideoProvider(asset.heroTag));
    ...
    return BaseActionButton(
      ...
      iconOnly: iconOnly,
      menuItem: menuItem,
      onPressed: () => ref.read(playOriginalVideoProvider(asset.heroTag).notifier).state = !playOriginalVideo,
    );
  }
}
