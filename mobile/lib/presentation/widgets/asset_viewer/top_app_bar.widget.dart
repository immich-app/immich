  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final actions = <Widget>[
      if (asset.isRemoteOnly && !isWaitingForSyncApproval)
        const DownloadActionButton(source: ActionSource.viewer, iconOnly: true),
      if (isCasting || (asset.hasRemote && !isWaitingForSyncApproval)) const CastActionButton(iconOnly: true),
