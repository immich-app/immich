...
class _NativeVideoViewerState extends ConsumerState<NativeVideoViewer> with WidgetsBindingObserver {
  ...
  VideoPlayerNotifier get _notifier => ref.read(videoPlayerProvider(widget.asset.playerKey).notifier);
  ...
  Widget build(BuildContext context) {
    ...
    final status = ref.watch(videoPlayerProvider(widget.asset.playerKey).select((v) => v.status));
