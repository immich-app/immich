...
const IOSDeviceAssetSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'hash': IndexSchema(
      ...
      unique: false,
      replace: false,
      properties: [IndexPropertySchema(name: r'hash', type: IndexType.hash, caseSensitive: false)],
    ),
  },
  links: {},
  embeddedSchemas: {},
...
int _iOSDeviceAssetEstimateSize(IOSDeviceAsset object, List<int> offsets, Map<Type, List<int>> allOffsets) {
...
IOSDeviceAsset _iOSDeviceAssetDeserialize(
  ...
  final object = IOSDeviceAsset(hash: reader.readByteList(offsets[0]) ?? [], id: reader.readString(offsets[1]));
  return object;
}

P _iOSDeviceAssetDeserializeProp<P>(IsarReader reader, int propertyId, int offset, Map<Type, List<int>> allOffsets) {
  switch (propertyId) {
    case 0:
...
extension IOSDeviceAssetQueryWhere on QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QWhereClause> {
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterWhereClause> hashEqualTo(List<int> hash) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(indexName: r'hash', value: [hash]));
    });
  }
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterWhereClause> hashNotEqualTo(List<int> hash) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(indexName: r'hash', lower: [], upper: [hash], includeUpper: false))
            .addWhereClause(
              IndexWhereClause.between(indexName: r'hash', lower: [hash], includeLower: false, upper: []),
            );
      } else {
        return query
            .addWhereClause(IndexWhereClause.between(indexName: r'hash', lower: [hash], includeLower: false, upper: []))
            .addWhereClause(
              IndexWhereClause.between(indexName: r'hash', lower: [], upper: [hash], includeUpper: false),
            );
      }
    });
  }
...
extension IOSDeviceAssetQueryFilter on QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QFilterCondition> {
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterFilterCondition> hashElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(property: r'hash', value: value));
    });
  }
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterFilterCondition> hashElementGreaterThan(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(include: include, property: r'hash', value: value));
    });
  }
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterFilterCondition> hashElementLessThan(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.lessThan(include: include, property: r'hash', value: value));
    });
  }
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterFilterCondition> hashLengthBetween(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'hash', lower, includeLower, upper, includeUpper);
    });
  }
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterFilterCondition> idContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IOSDeviceAsset, IOSDeviceAsset, QAfterFilterCondition> isarIdLessThan(Id value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
