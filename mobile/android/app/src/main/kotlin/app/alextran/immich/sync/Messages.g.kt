...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PlatformAsset {
      ...
      val durationInMilliseconds = pigeonVar_list[7] as Long
      ...
      return PlatformAsset(id, name, type, createdAt, updatedAt, width, height, durationInMilliseconds, orientation, isFavorite, adjustmentTime, latitude, longitude, playbackStyle)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.durationInMilliseconds)
