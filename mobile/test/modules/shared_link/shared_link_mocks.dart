...
class SharedLinkServiceMock extends Mock implements SharedLinkService {}

class ServerInfoServiceMock extends Mock implements ServerInfoService {}

class MockServerInfoNotifier extends ServerInfoNotifier with Mock implements ServerInfoNotifier {
  MockServerInfoNotifier({String externalDomain = 'https://demo.immich.app'}) : super(ServerInfoServiceMock()) {
