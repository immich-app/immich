...
void main() {
  ...
  group('getSortedAlbumIds', () {
    ...
    test('returns single album when only one album exists', () async {
      ...
      final asset = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 1));
    ...
    test('sorts albums by start date (MIN) ascending', () async {
      ...
      final asset1 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 10));
      final asset2 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 20));
      ...
      final asset3 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 5));
      final asset4 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 15));
      ...
      final album3 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset5 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 25));
      final asset6 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 30));
    ...
    test('handles albums with single asset', () async {
      final album1 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset1 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 15));
      await ctx.insertRemoteAlbumAsset(albumId: album1.id, assetId: asset1.id);

      final album2 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset2 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 10));
    ...
    test('only returns requested album IDs in the result', () async {
      ...
      final album2 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset2 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 5));
      await ctx.insertRemoteAlbumAsset(albumId: album2.id, assetId: asset2.id);

      final album3 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset3 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 15));
    ...
    test('handles albums with same date correctly', () async {
      ...
      final album1 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset1 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: sameDate);
      await ctx.insertRemoteAlbumAsset(albumId: album1.id, assetId: asset1.id);

      final album2 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset2 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: sameDate);
      await ctx.insertRemoteAlbumAsset(albumId: album2.id, assetId: asset2.id);
    ...
    test('handles albums across different years', () async {
      final album1 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset1 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2023, 12, 25));
      await ctx.insertRemoteAlbumAsset(albumId: album1.id, assetId: asset1.id);
      ...
      final album3 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset3 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2025, 1, 1));
      await ctx.insertRemoteAlbumAsset(albumId: album3.id, assetId: asset3.id);
    ...
    test('handles album with multiple assets correctly', () async {
      ...
      final asset1 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 5));
      final asset2 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 10));
      final asset3 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 15));
      final asset4 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 20));
      final asset5 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 25));
      await ctx.insertRemoteAlbumAsset(albumId: album1.id, assetId: asset1.id);
      await ctx.insertRemoteAlbumAsset(albumId: album1.id, assetId: asset2.id);
      ...
      final album2 = await ctx.newRemoteAlbum(ownerId: user.id);
      final asset6 = await ctx.newRemoteAsset(ownerId: user.id, createdAt: DateTime(2024, 1, 1));
