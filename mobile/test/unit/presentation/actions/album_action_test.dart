...
void main() {
  ...
  group('RemoveFromAlbumAction', () {
    ...
    testWidgets('is hidden for a local-only asset, which is not in the album', (tester) async {
  ...
  group('SetAlbumCoverAction', () {
    ...
    testWidgets('is hidden for more than one asset, since a cover is a single image', (tester) async {
      await tester.pumpTestWidget(
        context,
        const ActionIconButton(
    ...
    testWidgets('is hidden for a local-only asset, which has no remote id to point at', (tester) async {
      await tester.pumpTestWidget(
        context,
        const ActionIconButton(
          action: SetAlbumCoverAction(source: .timeline, albumId: albumId),
