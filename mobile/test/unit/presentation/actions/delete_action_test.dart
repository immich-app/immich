...
void main() {
  ...
  setUp(() async {
    ...
    when(context.repository.permission.hasManageMediaPermission).thenAnswer((_) async => false);
  });
  ...
  group('DeleteAction', () {
    ...
    group('prompt handling', () {
      ...
      testWidgets('local only delete on Android with MANAGE_MEDIA shows the prompt', (tester) async {
        ...
        when(context.repository.permission.hasManageMediaPermission).thenAnswer((_) async => true);
        final asset = LocalAssetFactory.create();
