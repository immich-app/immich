...
class UploadTasks extends Table with TableInfo<UploadTasks, UploadTasksData> {
  @override
  ...
  late final GeneratedColumn<int> isLivePhoto = GeneratedColumn<int>(
    'is_live_photo',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  @override
  UploadTasksData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return UploadTasksData(
...
class UploadTasksData extends DataClass implements Insertable<UploadTasksData> {
  final int? id;
  final int attempts;
  final int createdAt;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || isLivePhoto != null) {
      map['is_live_photo'] = Variable<int>(isLivePhoto);
    }
  ...
  factory UploadTasksData.fromJson(
    ...
    return UploadTasksData(
      ...
      isLivePhoto: serializer.fromJson<int?>(json['isLivePhoto']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isLivePhoto': serializer.toJson<int?>(isLivePhoto),
  ...
  UploadTasksData copyWith({
    Value<int?> id = const Value.absent(),
    int? attempts,
    int? createdAt,
    Value<String?> filePath = const Value.absent(),
    Value<int?> isLivePhoto = const Value.absent(),
  ...
  UploadTasksData copyWithCompanion(UploadTasksCompanion data) {
    return UploadTasksData(
  ...
  @override
  String toString() {
    return (StringBuffer('UploadTasksData(')
          ..write('id: $id, ')
...
class UploadTasksCompanion extends UpdateCompanion<UploadTasksData> {
  final Value<int?> id;
  final Value<int> attempts;
  final Value<int> createdAt;
  final Value<String?> filePath;
  final Value<int?> isLivePhoto;
  ...
  const UploadTasksCompanion({
    ...
    this.isLivePhoto = const Value.absent(),
  ...
  UploadTasksCompanion.insert({
    ...
    required int status,
       ...
       status = Value(status);
  static Insertable<UploadTasksData> custom({
    Expression<int>? id,
    Expression<int>? attempts,
    Expression<int>? createdAt,
    Expression<String>? filePath,
    Expression<int>? isLivePhoto,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isLivePhoto.present) {
      map['is_live_photo'] = Variable<int>(isLivePhoto.value);
    }
...
class UploadTaskStats extends Table
    with TableInfo<UploadTaskStats, UploadTaskStatsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  UploadTaskStats(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> pendingDownloads = GeneratedColumn<int>(
    'pending_downloads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> queuedDownloads = GeneratedColumn<int>(
    'queued_downloads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> queuedUploads = GeneratedColumn<int>(
    'queued_uploads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> failedDownloads = GeneratedColumn<int>(
    'failed_downloads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> failedUploads = GeneratedColumn<int>(
    'failed_uploads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> completedUploads = GeneratedColumn<int>(
    'completed_uploads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> skippedUploads = GeneratedColumn<int>(
    'skipped_uploads',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  UploadTaskStatsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return UploadTaskStatsData(
...
class UploadTaskStatsData extends DataClass
    implements Insertable<UploadTaskStatsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['pending_downloads'] = Variable<int>(pendingDownloads);
    map['pending_uploads'] = Variable<int>(pendingUploads);
    map['queued_downloads'] = Variable<int>(queuedDownloads);
    map['queued_uploads'] = Variable<int>(queuedUploads);
    map['failed_downloads'] = Variable<int>(failedDownloads);
    map['failed_uploads'] = Variable<int>(failedUploads);
    map['completed_uploads'] = Variable<int>(completedUploads);
    map['skipped_uploads'] = Variable<int>(skippedUploads);
    return map;
  }

  factory UploadTaskStatsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return UploadTaskStatsData(
      pendingDownloads: serializer.fromJson<int>(json['pendingDownloads']),
      pendingUploads: serializer.fromJson<int>(json['pendingUploads']),
      queuedDownloads: serializer.fromJson<int>(json['queuedDownloads']),
      queuedUploads: serializer.fromJson<int>(json['queuedUploads']),
      failedDownloads: serializer.fromJson<int>(json['failedDownloads']),
      failedUploads: serializer.fromJson<int>(json['failedUploads']),
      completedUploads: serializer.fromJson<int>(json['completedUploads']),
      skippedUploads: serializer.fromJson<int>(json['skippedUploads']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return <String, dynamic>{
      'pendingDownloads': serializer.toJson<int>(pendingDownloads),
      'pendingUploads': serializer.toJson<int>(pendingUploads),
      'queuedDownloads': serializer.toJson<int>(queuedDownloads),
      'queuedUploads': serializer.toJson<int>(queuedUploads),
      'failedDownloads': serializer.toJson<int>(failedDownloads),
      'failedUploads': serializer.toJson<int>(failedUploads),
      'completedUploads': serializer.toJson<int>(completedUploads),
      'skippedUploads': serializer.toJson<int>(skippedUploads),
    };
  }

  UploadTaskStatsData copyWith({
  ...
  UploadTaskStatsData copyWithCompanion(UploadTaskStatsCompanion data) {
    return UploadTaskStatsData(
  ...
  @override
  String toString() {
    return (StringBuffer('UploadTaskStatsData(')
...
class UploadTaskStatsCompanion extends UpdateCompanion<UploadTaskStatsData> {
  final Value<int> pendingDownloads;
  final Value<int> pendingUploads;
  final Value<int> queuedDownloads;
  final Value<int> queuedUploads;
  final Value<int> failedDownloads;
  final Value<int> failedUploads;
  final Value<int> completedUploads;
  final Value<int> skippedUploads;
  final Value<int> rowid;
  const UploadTaskStatsCompanion({
    this.pendingDownloads = const Value.absent(),
    this.pendingUploads = const Value.absent(),
    this.queuedDownloads = const Value.absent(),
    this.queuedUploads = const Value.absent(),
    this.failedDownloads = const Value.absent(),
    this.failedUploads = const Value.absent(),
    this.completedUploads = const Value.absent(),
    this.skippedUploads = const Value.absent(),
  ...
  UploadTaskStatsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
  }) : pendingDownloads = Value(pendingDownloads),
       pendingUploads = Value(pendingUploads),
       queuedDownloads = Value(queuedDownloads),
       queuedUploads = Value(queuedUploads),
       failedDownloads = Value(failedDownloads),
       failedUploads = Value(failedUploads),
       completedUploads = Value(completedUploads),
       skippedUploads = Value(skippedUploads);
  static Insertable<UploadTaskStatsData> custom({
    Expression<int>? pendingDownloads,
    Expression<int>? pendingUploads,
    Expression<int>? queuedDownloads,
    Expression<int>? queuedUploads,
    Expression<int>? failedDownloads,
    Expression<int>? failedUploads,
    Expression<int>? completedUploads,
    Expression<int>? skippedUploads,
  ...
  UploadTaskStatsCompanion copyWith({
    Value<int>? pendingDownloads,
    Value<int>? pendingUploads,
    Value<int>? queuedDownloads,
    Value<int>? queuedUploads,
    Value<int>? failedDownloads,
    Value<int>? failedUploads,
    Value<int>? completedUploads,
    Value<int>? skippedUploads,
    Value<int>? rowid,
  }) {
    return UploadTaskStatsCompanion(
      pendingDownloads: pendingDownloads ?? this.pendingDownloads,
      pendingUploads: pendingUploads ?? this.pendingUploads,
      queuedDownloads: queuedDownloads ?? this.queuedDownloads,
      queuedUploads: queuedUploads ?? this.queuedUploads,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pendingDownloads.present) {
      map['pending_downloads'] = Variable<int>(pendingDownloads.value);
    }
    if (pendingUploads.present) {
      map['pending_uploads'] = Variable<int>(pendingUploads.value);
    }
    if (queuedDownloads.present) {
      map['queued_downloads'] = Variable<int>(queuedDownloads.value);
    }
    if (queuedUploads.present) {
      map['queued_uploads'] = Variable<int>(queuedUploads.value);
    }
    if (failedDownloads.present) {
      map['failed_downloads'] = Variable<int>(failedDownloads.value);
    }
    if (failedUploads.present) {
      map['failed_uploads'] = Variable<int>(failedUploads.value);
    }
    if (completedUploads.present) {
      map['completed_uploads'] = Variable<int>(completedUploads.value);
    }
    if (skippedUploads.present) {
      map['skipped_uploads'] = Variable<int>(skippedUploads.value);
    }
    if (rowid.present) {
...
class DatabaseAtV14 extends GeneratedDatabase {
  ...
  late final UploadTasks uploadTasks = UploadTasks(this);
  late final UploadTaskStats uploadTaskStats = UploadTaskStats(this);
  late final Trigger updateStatsInsert = Trigger(
  ...
  late final Trigger updateStatsUpdate = Trigger(
  ...
  late final Trigger updateStatsDelete = Trigger(
