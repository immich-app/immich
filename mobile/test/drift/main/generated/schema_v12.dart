...
class LocalAssetEntity extends Table
  ...
  late final GeneratedColumn<int> adjustmentTimestamp = GeneratedColumn<int>(
...
class LocalAssetEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || adjustmentTimestamp != null) {
      map['adjustment_timestamp'] = Variable<int>(adjustmentTimestamp);
    }
    return map;
  }
  ...
  LocalAssetEntityData copyWith({
    ...
    bool? isFavorite,
    int? orientation,
    Value<int?> adjustmentTimestamp = const Value.absent(),
...
class LocalAssetEntityCompanion extends UpdateCompanion<LocalAssetEntityData> {
  ...
  final Value<int?> adjustmentTimestamp;
  const LocalAssetEntityCompanion({
    ...
    this.adjustmentTimestamp = const Value.absent(),
  });
  ...
  static Insertable<LocalAssetEntityData> custom({
    ...
    Expression<int>? adjustmentTimestamp,
  }) {
    return RawValuesInsertable({
      if (name != null) 'name': name,
      if (type != null) 'type': type,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (adjustmentTimestamp.present) {
      map['adjustment_timestamp'] = Variable<int>(adjustmentTimestamp.value);
    }
    return map;
  }
