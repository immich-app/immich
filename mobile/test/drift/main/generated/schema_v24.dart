...
class SharedSpaceEntity extends Table
  ...
  late final GeneratedColumn<bool> faceRecognitionEnabled =
  ...
  late final GeneratedColumn<bool> petsEnabled = GeneratedColumn<bool>(
    'pets_enabled',
    aliasedName,
    false,
    type: DriftSqlType.bool,
...
class SharedSpaceEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['face_recognition_enabled'] = Variable<bool>(faceRecognitionEnabled);
    map['pets_enabled'] = Variable<bool>(petsEnabled);
...
class SharedSpaceEntityCompanion
  ...
  final Value<bool> faceRecognitionEnabled;
  final Value<bool> petsEnabled;
  ...
  static Insertable<SharedSpaceEntityData> custom({
    ...
    Expression<bool>? faceRecognitionEnabled,
    Expression<bool>? petsEnabled,
  ...
  SharedSpaceEntityCompanion copyWith({
    ...
    Value<bool>? faceRecognitionEnabled,
    Value<bool>? petsEnabled,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (faceRecognitionEnabled.present) {
      map['face_recognition_enabled'] = Variable<bool>(
        faceRecognitionEnabled.value,
      );
    }
    if (petsEnabled.present) {
      map['pets_enabled'] = Variable<bool>(petsEnabled.value);
    }
