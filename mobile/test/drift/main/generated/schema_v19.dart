...
class SyncExclusionEntity extends Table
    with TableInfo<SyncExclusionEntity, SyncExclusionEntityData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncExclusionEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> remoteAssetId = GeneratedColumn<String>(
    'remote_asset_id',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> localAlbumId = GeneratedColumn<String>(
    'local_album_id',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {remoteAssetId, localAlbumId};
  @override
  SyncExclusionEntityData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  SyncExclusionEntity createAlias(String alias) {
    return SyncExclusionEntity(attachedDatabase, alias);
  }
...
class SyncExclusionEntityData extends DataClass
    implements Insertable<SyncExclusionEntityData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['remote_asset_id'] = Variable<String>(remoteAssetId);
    map['local_album_id'] = Variable<String>(localAlbumId);
  ...
  SyncExclusionEntityData copyWith({
    String? remoteAssetId,
    String? localAlbumId,
    DateTime? excludedAt,
  }) => SyncExclusionEntityData(
  ...
  SyncExclusionEntityData copyWithCompanion(SyncExclusionEntityCompanion data) {
    return SyncExclusionEntityData(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SyncExclusionEntityData &&
...
class SyncExclusionEntityCompanion
    extends UpdateCompanion<SyncExclusionEntityData> {
  final Value<String> remoteAssetId;
  final Value<String> localAlbumId;
  final Value<DateTime> excludedAt;
  const SyncExclusionEntityCompanion({
    this.remoteAssetId = const Value.absent(),
    this.localAlbumId = const Value.absent(),
  ...
  SyncExclusionEntityCompanion.insert({
    ...
    this.excludedAt = const Value.absent(),
       ...
       localAlbumId = Value(localAlbumId);
  static Insertable<SyncExclusionEntityData> custom({
    Expression<String>? remoteAssetId,
    Expression<String>? localAlbumId,
  ...
  SyncExclusionEntityCompanion copyWith({
    Value<String>? remoteAssetId,
    Value<String>? localAlbumId,
    Value<DateTime>? excludedAt,
  }) {
    return SyncExclusionEntityCompanion(
      remoteAssetId: remoteAssetId ?? this.remoteAssetId,
      localAlbumId: localAlbumId ?? this.localAlbumId,
      excludedAt: excludedAt ?? this.excludedAt,
    );
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (remoteAssetId.present) {
      map['remote_asset_id'] = Variable<String>(remoteAssetId.value);
    }
    if (localAlbumId.present) {
      map['local_album_id'] = Variable<String>(localAlbumId.value);
    }
...
class DatabaseAtV19 extends GeneratedDatabase {
  ...
  late final SyncExclusionEntity syncExclusionEntity = SyncExclusionEntity(
    this,
  );
