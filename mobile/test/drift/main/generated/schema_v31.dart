...
class LocalAssetEntity extends Table
  ...
  late final GeneratedColumn<int> isBackupCandidate = GeneratedColumn<int>(
    'is_backup_candidate',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class LocalAssetEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_favorite'] = Variable<int>(isFavorite);
    map['is_backup_candidate'] = Variable<int>(isBackupCandidate);
  ...
  factory LocalAssetEntityData.fromJson(
    ...
    return LocalAssetEntityData(
      ...
      checksum: serializer.fromJson<String?>(json['checksum']),
      isFavorite: serializer.fromJson<int>(json['isFavorite']),
      isBackupCandidate: serializer.fromJson<int>(json['isBackupCandidate']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'checksum': serializer.toJson<String?>(checksum),
      'isFavorite': serializer.toJson<int>(isFavorite),
      'isBackupCandidate': serializer.toJson<int>(isBackupCandidate),
...
class LocalAssetEntityCompanion extends UpdateCompanion<LocalAssetEntityData> {
  ...
  final Value<String?> checksum;
  final Value<int> isFavorite;
  final Value<int> isBackupCandidate;
  ...
  const LocalAssetEntityCompanion({
    ...
    this.checksum = const Value.absent(),
    this.isFavorite = const Value.absent(),
    this.isBackupCandidate = const Value.absent(),
  ...
  static Insertable<LocalAssetEntityData> custom({
    ...
    Expression<String>? checksum,
    Expression<int>? isFavorite,
    Expression<int>? isBackupCandidate,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isBackupCandidate.present) {
      map['is_backup_candidate'] = Variable<int>(isBackupCandidate.value);
    }
...
class DatabaseAtV31 extends GeneratedDatabase {
  ...
  late final Index idxLocalAssetBackupCandidate = Index(
