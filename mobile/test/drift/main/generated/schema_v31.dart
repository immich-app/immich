...
class OfflineAlbumEntity extends Table
    with TableInfo<OfflineAlbumEntity, OfflineAlbumEntityData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  OfflineAlbumEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> albumId = GeneratedColumn<String>(
    'album_id',
    aliasedName,
    false,
  ...
  @override
  List<GeneratedColumn> get $columns => [albumId, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  OfflineAlbumEntityData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  OfflineAlbumEntity createAlias(String alias) {
    return OfflineAlbumEntity(attachedDatabase, alias);
  }
...
class OfflineAlbumEntityData extends DataClass
    implements Insertable<OfflineAlbumEntityData> {
  final String albumId;
  final String createdAt;
  ...
  OfflineAlbumEntityData copyWith({String? albumId, String? createdAt}) =>
      OfflineAlbumEntityData(
        albumId: albumId ?? this.albumId,
        createdAt: createdAt ?? this.createdAt,
      );
  OfflineAlbumEntityData copyWithCompanion(OfflineAlbumEntityCompanion data) {
    return OfflineAlbumEntityData(
      albumId: data.albumId.present ? data.albumId.value : this.albumId,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is OfflineAlbumEntityData &&
          other.albumId == this.albumId &&
          other.createdAt == this.createdAt);
}

class OfflineAlbumEntityCompanion
    extends UpdateCompanion<OfflineAlbumEntityData> {
  final Value<String> albumId;
  final Value<String> createdAt;
  ...
  static Insertable<OfflineAlbumEntityData> custom({
    Expression<String>? albumId,
    Expression<String>? createdAt,
  }) {
    return RawValuesInsertable({
  ...
  OfflineAlbumEntityCompanion copyWith({
    Value<String>? albumId,
    Value<String>? createdAt,
  }) {
    return OfflineAlbumEntityCompanion(
      albumId: albumId ?? this.albumId,
      createdAt: createdAt ?? this.createdAt,
    );
  }
...
class OfflineAssetEntity extends Table
    with TableInfo<OfflineAssetEntity, OfflineAssetEntityData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  OfflineAssetEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> assetId = GeneratedColumn<String>(
    'asset_id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> thumbFileName = GeneratedColumn<String>(
    'thumb_file_name',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  Set<GeneratedColumn> get $primaryKey => {assetId};
  @override
  OfflineAssetEntityData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  OfflineAssetEntity createAlias(String alias) {
    return OfflineAssetEntity(attachedDatabase, alias);
  }
...
class OfflineAssetEntityData extends DataClass
    implements Insertable<OfflineAssetEntityData> {
  final String assetId;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || thumbFileName != null) {
      map['thumb_file_name'] = Variable<String>(thumbFileName);
    }
    map['file_size'] = Variable<int>(fileSize);
    map['created_at'] = Variable<String>(createdAt);
    return map;
  ...
  OfflineAssetEntityData copyWith({
    String? assetId,
    Value<String?> fileName = const Value.absent(),
    Value<String?> thumbFileName = const Value.absent(),
    int? fileSize,
    String? createdAt,
  }) => OfflineAssetEntityData(
    assetId: assetId ?? this.assetId,
  ...
  OfflineAssetEntityData copyWithCompanion(OfflineAssetEntityCompanion data) {
    return OfflineAssetEntityData(
      assetId: data.assetId.present ? data.assetId.value : this.assetId,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is OfflineAssetEntityData &&
          other.assetId == this.assetId &&
...
class OfflineAssetEntityCompanion
    extends UpdateCompanion<OfflineAssetEntityData> {
  final Value<String> assetId;
  final Value<String?> fileName;
  final Value<String?> thumbFileName;
  final Value<int> fileSize;
  final Value<String> createdAt;
  const OfflineAssetEntityCompanion({
    this.assetId = const Value.absent(),
    this.fileName = const Value.absent(),
    this.thumbFileName = const Value.absent(),
    this.fileSize = const Value.absent(),
    this.createdAt = const Value.absent(),
  });
  ...
  static Insertable<OfflineAssetEntityData> custom({
    Expression<String>? assetId,
    Expression<String>? fileName,
    Expression<String>? thumbFileName,
    Expression<int>? fileSize,
    Expression<String>? createdAt,
  }) {
    return RawValuesInsertable({
  ...
  OfflineAssetEntityCompanion copyWith({
    Value<String>? assetId,
    Value<String?>? fileName,
    Value<String?>? thumbFileName,
    Value<int>? fileSize,
    Value<String>? createdAt,
  }) {
    return OfflineAssetEntityCompanion(
      assetId: assetId ?? this.assetId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (thumbFileName.present) {
      map['thumb_file_name'] = Variable<String>(thumbFileName.value);
    }
    if (fileSize.present) {
      map['file_size'] = Variable<int>(fileSize.value);
    }
...
class DatabaseAtV31 extends GeneratedDatabase {
  ...
  late final OfflineAlbumEntity offlineAlbumEntity = OfflineAlbumEntity(this);
  late final OfflineAssetEntity offlineAssetEntity = OfflineAssetEntity(this);
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('offline_album_entity', kind: UpdateKind.delete)],
    ),
  ]);
  @override
