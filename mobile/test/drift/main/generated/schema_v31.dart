...
class LocalAlbumEntity extends Table
  ...
  late final GeneratedColumn<int> defaultVisibility = GeneratedColumn<int>(
    'default_visibility',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  LocalAlbumEntityData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocalAlbumEntityData(
      ...
      defaultVisibility: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class LocalAlbumEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['default_visibility'] = Variable<int>(defaultVisibility);
  ...
  factory LocalAlbumEntityData.fromJson(
    ...
    return LocalAlbumEntityData(
      ...
      defaultVisibility: serializer.fromJson<int>(json['defaultVisibility']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'defaultVisibility': serializer.toJson<int>(defaultVisibility),
...
class LocalAlbumEntityCompanion extends UpdateCompanion<LocalAlbumEntityData> {
  ...
  final Value<int> defaultVisibility;
  ...
  static Insertable<LocalAlbumEntityData> custom({
    ...
    Expression<int>? defaultVisibility,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (defaultVisibility.present) {
      map['default_visibility'] = Variable<int>(defaultVisibility.value);
    }
    if (marker.present) {
