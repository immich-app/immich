...
class AuthUserEntity extends Table
  ...
  late final GeneratedColumn<bool> isAdmin = GeneratedColumn<bool>(
      ...
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<String> oauthId = GeneratedColumn<String>(
  ...
  late final GeneratedColumn<bool> hasProfileImage = GeneratedColumn<bool>(
      'has_profile_image', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  late final GeneratedColumn<DateTime> profileChangedAt =
      GeneratedColumn<DateTime>('profile_changed_at', aliasedName, false,
          type: DriftSqlType.dateTime,
          requiredDuringInsert: false,
          defaultValue: const CustomExpression('CURRENT_TIMESTAMP'));
  ...
  late final GeneratedColumn<int> quotaUsageInBytes = GeneratedColumn<int>(
      ...
      requiredDuringInsert: false,
      defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<String> storageLabel = GeneratedColumn<String>(
      'storage_label', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  @override
  List<GeneratedColumn> get $columns => [
        id,
  ...
  AuthUserEntityData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AuthUserEntityData(
      ...
      oauthId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}oauth_id'])!,
      ...
      hasProfileImage: attachedDatabase.typeMapping.read(
          DriftSqlType.bool, data['${effectivePrefix}has_profile_image'])!,
      profileChangedAt: attachedDatabase.typeMapping.read(
          DriftSqlType.dateTime, data['${effectivePrefix}profile_changed_at'])!,
      ...
      storageLabel: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}storage_label']),
    );
  }
...
class AuthUserEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['oauth_id'] = Variable<String>(oauthId);
    ...
    if (!nullToAbsent || storageLabel != null) {
      map['storage_label'] = Variable<String>(storageLabel);
    }
    return map;
  }
  ...
  AuthUserEntityData copyWith(
          ...
          Value<String?> storageLabel = const Value.absent()}) =>
      AuthUserEntityData(
        id: id ?? this.id,
        name: name ?? this.name,
        email: email ?? this.email,
...
class AuthUserEntityCompanion extends UpdateCompanion<AuthUserEntityData> {
  ...
  final Value<String?> storageLabel;
  const AuthUserEntityCompanion({
    ...
    this.oauthId = const Value.absent(),
    ...
    this.storageLabel = const Value.absent(),
  });
  ...
  static Insertable<AuthUserEntityData> custom({
    ...
    Expression<String>? storageLabel,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (name != null) 'name': name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (oauthId.present) {
      map['oauth_id'] = Variable<String>(oauthId.value);
    }
    if (pinCode.present) {
    ...
    if (storageLabel.present) {
      map['storage_label'] = Variable<String>(storageLabel.value);
    }
    return map;
  }
