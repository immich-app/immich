...
[**sendAllJobsCommand**](JobApi.md#sendalljobscommand) | **POST** /jobs/all | 
...
# **sendAllJobsCommand**
> AllJobStatusResponseDto sendAllJobsCommand(jobCommandDto)
...
try {
    final result = api_instance.sendAllJobsCommand(jobCommandDto);
    print(result);
} catch (e) {
    print('Exception when calling JobApi->sendAllJobsCommand: $e\n');
}
```
