...
[**getPersonAlbums**](PersonApi.md#getpersonalbums) | **GET** /person/{id}/albums | 
...
# **getPersonAlbums**
> List<AlbumsForPersonResponseDto> getPersonAlbums(id)
...
try {
    final result = api_instance.getPersonAlbums(id);
    print(result);
} catch (e) {
    print('Exception when calling PersonApi->getPersonAlbums: $e\n');
}
```
...
[**List<AlbumsForPersonResponseDto>**](AlbumsForPersonResponseDto.md)
