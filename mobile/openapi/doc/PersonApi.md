...
[**getFaceThumbnail**](PersonApi.md#getfacethumbnail) | **GET** /person/{id}/thumbnail | 
...
# **getFaceThumbnail**
> MultipartFile getFaceThumbnail(id)
...
try {
    final result = api_instance.getFaceThumbnail(id);
    print(result);
} catch (e) {
    print('Exception when calling PersonApi->getFaceThumbnail: $e\n');
}
```
