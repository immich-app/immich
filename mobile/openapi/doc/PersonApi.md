...
[**updateFaceThumbnail**](PersonApi.md#updatefacethumbnail) | **PUT** /person/{id}/update-face/{assetId} | 
...
# **updateFaceThumbnail**
> updateFaceThumbnail(id, assetId)
...
try {
    api_instance.updateFaceThumbnail(id, assetId);
} catch (e) {
    print('Exception when calling PersonApi->updateFaceThumbnail: $e\n');
}
```
