...
[**restoreUser**](UsersApi.md#restoreuser) | **POST** /users/{id}/restore | 
...
# **updateUser**
> UserResponseDto updateUser(id, updateUserDto)
...
try {
    final result = api_instance.updateUser(id, updateUserDto);
    print(result);
} catch (e) {
