...
try {
    final result = api_instance.emptyTrash();
    print(result);
} catch (e) {
...
# **restoreAssets**
> TrashResponseDto restoreAssets(bulkIdsDto)
...
try {
    final result = api_instance.restoreAssets(bulkIdsDto);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.restoreTrash();
    print(result);
} catch (e) {
