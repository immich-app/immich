...
[**updateAlbumOrder**](AlbumApi.md#updatealbumorder) | **PATCH** /album/{id}/order | 
...
# **updateAlbumOrder**
> UpdateAlbumDto updateAlbumOrder(id, updateAlbumOrderDto)
...
final api_instance = AlbumApi();
final id = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final updateAlbumOrderDto = UpdateAlbumOrderDto(); // UpdateAlbumOrderDto | 

try {
    final result = api_instance.updateAlbumOrder(id, updateAlbumOrderDto);
    print(result);
} catch (e) {
    print('Exception when calling AlbumApi->updateAlbumOrder: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **id** | **String**|  | 
 **updateAlbumOrderDto** | [**UpdateAlbumOrderDto**](UpdateAlbumOrderDto.md)|  | 

### Return type

[**UpdateAlbumDto**](UpdateAlbumDto.md)
