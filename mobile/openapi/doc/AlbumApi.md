...
# **addAssetsToAlbum**
> List<AssetIdsResponseDto> addAssetsToAlbum(id, assetIdsDto, key)
...
try {
    final result = api_instance.addAssetsToAlbum(id, assetIdsDto, key);
    print(result);
} catch (e) {
...
> List<AssetIdsResponseDto> removeAssetFromAlbum(id, assetIdsDto)
...
try {
    final result = api_instance.removeAssetFromAlbum(id, assetIdsDto);
    print(result);
} catch (e) {
