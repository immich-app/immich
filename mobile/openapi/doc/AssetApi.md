...
# **getAllAssets**
> List<AssetResponseDto> getAllAssets(userId, isFavorite, isArchived, withDeleted, skip, updatedAfter, ifNoneMatch)
...
try {
    final result = api_instance.getAllAssets(userId, isFavorite, isArchived, withDeleted, skip, updatedAfter, ifNoneMatch);
    print(result);
} catch (e) {
