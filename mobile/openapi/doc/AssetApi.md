...
[**DuplicateAssetResponseDto**](DuplicateAssetResponseDto.md)
...
# **replaceAsset**
> DuplicateAssetResponseDto replaceAsset(id, assetData, deviceAssetId, deviceId, fileCreatedAt, fileModifiedAt, key, duration)
