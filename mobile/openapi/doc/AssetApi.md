...
[**getByLibraryIdAndOriginalPath**](AssetApi.md#getbylibraryidandoriginalpath) | **GET** /asset/by-library-and-path | 
...
try {
    final result = api_instance.getByLibraryIdAndOriginalPath(libraryId, originalPath);
    print(result);
} catch (e) {
    print('Exception when calling AssetApi->getByLibraryIdAndOriginalPath: $e\n');
}
```
