...
[**getTimelineLayout**](AssetApi.md#gettimelinelayout) | **POST** /asset/timeline-layout | 
...
# **getTimelineLayout**
> List<AssetTimelineLayoutResponseDto> getTimelineLayout(getTimelineLayoutDto)
...
final api_instance = AssetApi();
final getTimelineLayoutDto = GetTimelineLayoutDto(); // GetTimelineLayoutDto | 

try {
    final result = api_instance.getTimelineLayout(getTimelineLayoutDto);
    print(result);
} catch (e) {
    print('Exception when calling AssetApi->getTimelineLayout: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **getTimelineLayoutDto** | [**GetTimelineLayoutDto**](GetTimelineLayoutDto.md)|  | 

### Return type

[**List<AssetTimelineLayoutResponseDto>**](AssetTimelineLayoutResponseDto.md)
