...
**language** | **Optional<String?>** | Search language code | [optional] 
...
**query** | **Optional<String?>** | Natural language search query | [optional] 
**queryAssetId** | **Optional<String?>** | Asset ID to use as search reference | [optional] 
