...
[**validatePrivateAlbumPassword**](UserApi.md#validateprivatealbumpassword) | **POST** /user/validate-private-album-password | 
...
# **validatePrivateAlbumPassword**
> validatePrivateAlbumPassword(validatePrivateAlbumPasswordDto)
...
final api_instance = UserApi();
final validatePrivateAlbumPasswordDto = ValidatePrivateAlbumPasswordDto(); // ValidatePrivateAlbumPasswordDto | 

try {
    api_instance.validatePrivateAlbumPassword(validatePrivateAlbumPasswordDto);
} catch (e) {
    print('Exception when calling UserApi->validatePrivateAlbumPassword: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **validatePrivateAlbumPasswordDto** | [**ValidatePrivateAlbumPasswordDto**](ValidatePrivateAlbumPasswordDto.md)|  | 
