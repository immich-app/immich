...
[**getFaceThumbnail**](PeopleApi.md#getfacethumbnail) | **GET** /people/{id}/thumbnail | 
...
try {
    ...
    print('Exception when calling PeopleApi->getFaceThumbnail: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PeopleApi->getPersonAssets: $e\n');
}
```
