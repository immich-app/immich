...
[**getExcludePattern**](LibraryApi.md#getexcludepattern) | **GET** /library/{id}/excludePatterns | 
...
[**setExcludePatterns**](LibraryApi.md#setexcludepatterns) | **POST** /library/{id}/excludePatterns | 
...
# **getExcludePattern**
> List<String> getExcludePattern(id)
...
try {
    final result = api_instance.getExcludePattern(id);
    print(result);
} catch (e) {
    print('Exception when calling LibraryApi->getExcludePattern: $e\n');
}
```
...
# **setExcludePatterns**
> LibraryResponseDto setExcludePatterns(id, setExcludePatternsDto)
...
final api_instance = LibraryApi();
final id = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final setExcludePatternsDto = SetExcludePatternsDto(); // SetExcludePatternsDto | 

try {
    final result = api_instance.setExcludePatterns(id, setExcludePatternsDto);
    print(result);
} catch (e) {
    print('Exception when calling LibraryApi->setExcludePatterns: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **id** | **String**|  | 
 **setExcludePatternsDto** | [**SetExcludePatternsDto**](SetExcludePatternsDto.md)|  | 
