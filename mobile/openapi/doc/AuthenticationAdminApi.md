# openapi.api.AuthenticationAdminApi
...
final api_instance = AuthenticationAdminApi();

try {
    api_instance.unlinkAllOAuthAccountsAdmin();
} catch (e) {
    print('Exception when calling AuthenticationAdminApi->unlinkAllOAuthAccountsAdmin: $e\n');
}
```
