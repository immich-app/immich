...
class NotificationUpdateDto {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotificationUpdateDto && other.readAt == readAt;
  ...
  static List<NotificationUpdateDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<NotificationUpdateDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = NotificationUpdateDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
