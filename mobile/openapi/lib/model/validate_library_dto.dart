...
class ValidateLibraryDto {
  ...
  int get hashCode =>
      ...
      (exclusionPatterns.hashCode) + (importPaths.hashCode);
  ...
  static List<ValidateLibraryDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ValidateLibraryDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ValidateLibraryDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
