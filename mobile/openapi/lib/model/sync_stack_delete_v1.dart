...
class SyncStackDeleteV1 {
  ...
  static SyncStackDeleteV1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'stackId'), 'Required key "SyncStackDeleteV1[stackId]" is missing from JSON.');
        assert(json[r'stackId'] != null, 'Required key "SyncStackDeleteV1[stackId]" has a null value in JSON.');
        return true;
      }());
