...
class SyncAssetDeleteV1 {
  ...
  static SyncAssetDeleteV1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'assetId'), 'Required key "SyncAssetDeleteV1[assetId]" is missing from JSON.');
        assert(json[r'assetId'] != null, 'Required key "SyncAssetDeleteV1[assetId]" has a null value in JSON.');
        return true;
      }());
