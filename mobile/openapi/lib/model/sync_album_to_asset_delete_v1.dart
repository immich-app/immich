...
class SyncAlbumToAssetDeleteV1 {
  ...
  bool operator ==(Object other) =>
      ...
      other is SyncAlbumToAssetDeleteV1 && other.albumId == albumId && other.assetId == assetId;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (albumId.hashCode) + (assetId.hashCode);
  ...
  static List<SyncAlbumToAssetDeleteV1> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SyncAlbumToAssetDeleteV1>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SyncAlbumToAssetDeleteV1.listFromJson(
          entry.value,
          growable: growable,
        );
      }
