...
class TagUpsertDto {
  ...
  static TagUpsertDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'tags'), 'Required key "TagUpsertDto[tags]" is missing from JSON.');
        assert(json[r'tags'] != null, 'Required key "TagUpsertDto[tags]" has a null value in JSON.');
        return true;
      }());
