...
class SharedLinkEntity {
  ...
  @override
  String toString() => 'SharedLinkEntity[album=$album, albumId=$albumId, allowDownload=$allowDownload, allowUpload=$allowUpload, assets=$assets, createdAt=$createdAt, description=$description, expiresAt=$expiresAt, id=$id, key=$key, password=$password, showExif=$showExif, type=$type, user=$user, userId=$userId]';
