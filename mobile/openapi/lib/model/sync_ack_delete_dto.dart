...
class SyncAckDeleteDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is SyncAckDeleteDto && _deepEquality.equals(other.types, types);
  ...
  static List<SyncAckDeleteDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SyncAckDeleteDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SyncAckDeleteDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
