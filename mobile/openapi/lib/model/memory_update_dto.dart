...
class MemoryUpdateDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is MemoryUpdateDto && other.isSaved == isSaved && other.memoryAt == memoryAt && other.seenAt == seenAt;
  ...
  static List<MemoryUpdateDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MemoryUpdateDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MemoryUpdateDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
