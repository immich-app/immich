...
class SyncStreamDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is SyncStreamDto && other.reset == reset && _deepEquality.equals(other.types, types);

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (reset == null ? 0 : reset!.hashCode) + (types.hashCode);
  ...
  static List<SyncStreamDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SyncStreamDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SyncStreamDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
