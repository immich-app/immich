...
class ExifResponseDto {
  ...
  static ExifResponseDto? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return ExifResponseDto(
        ...
        exifImageHeight: json[r'exifImageHeight'] == null ? null : num.parse('${json[r'exifImageHeight']}'),
        exifImageWidth: json[r'exifImageWidth'] == null ? null : num.parse('${json[r'exifImageWidth']}'),
        exposureTime: mapValueOfType<String>(json, r'exposureTime'),
        fNumber: json[r'fNumber'] == null ? null : num.parse('${json[r'fNumber']}'),
        fileSizeInByte: mapValueOfType<int>(json, r'fileSizeInByte'),
        focalLength: json[r'focalLength'] == null ? null : num.parse('${json[r'focalLength']}'),
        iso: json[r'iso'] == null ? null : num.parse('${json[r'iso']}'),
        latitude: json[r'latitude'] == null ? null : num.parse('${json[r'latitude']}'),
        lensModel: mapValueOfType<String>(json, r'lensModel'),
        longitude: json[r'longitude'] == null ? null : num.parse('${json[r'longitude']}'),
        ...
        fps: json[r'fps'] == null ? null : num.parse('${json[r'fps']}'),
        bitRate: json[r'bitRate'] == null ? null : num.parse('${json[r'bitRate']}'),
  ...
  static List<ExifResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ExifResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ExifResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
