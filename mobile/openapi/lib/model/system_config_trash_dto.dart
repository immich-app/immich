...
class SystemConfigTrashDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is SystemConfigTrashDto && other.days == days && other.enabled == enabled;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (days.hashCode) + (enabled.hashCode);
  ...
  static List<SystemConfigTrashDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SystemConfigTrashDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SystemConfigTrashDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
