...
class MemoriesUpdate {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MemoriesUpdate && other.enabled == enabled;
  ...
  static List<MemoriesUpdate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MemoriesUpdate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MemoriesUpdate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
