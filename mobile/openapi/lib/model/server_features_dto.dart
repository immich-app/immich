...
class ServerFeaturesDto {
  ...
  @override
  String toString() => 'ServerFeaturesDto[configFile=$configFile, duplicateDetection=$duplicateDetection, email=$email, facialRecognition=$facialRecognition, importFaces=$importFaces, map=$map, oauth=$oauth, oauthAutoLaunch=$oauthAutoLaunch, ocr=$ocr, passwordLogin=$passwordLogin, petRecognition=$petRecognition, reverseGeocoding=$reverseGeocoding, search=$search, sidecar=$sidecar, smartSearch=$smartSearch, trash=$trash]';
  ...
  static ServerFeaturesDto? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return ServerFeaturesDto(
        ...
        petRecognition: mapValueOfType<bool>(json, r'petRecognition')!,
