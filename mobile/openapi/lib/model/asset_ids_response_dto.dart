...
class AssetIdsResponseDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is AssetIdsResponseDto && other.assetId == assetId && other.error == error && other.success == success;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (assetId.hashCode) + (error == null ? 0 : error!.hashCode) + (success.hashCode);
