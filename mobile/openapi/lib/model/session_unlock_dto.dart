...
class SessionUnlockDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is SessionUnlockDto && other.password == password && other.pinCode == pinCode;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (password == null ? 0 : password!.hashCode) + (pinCode == null ? 0 : pinCode!.hashCode);
  ...
  static List<SessionUnlockDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SessionUnlockDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SessionUnlockDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
