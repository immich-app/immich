...
class CreateLibraryDto {
  ...
  @override
  String toString() => 'CreateLibraryDto[exclusionPatterns=$exclusionPatterns, importPaths=$importPaths, isReadOnly=$isReadOnly, isVisible=$isVisible, name=$name, ownerId=$ownerId, type=$type]';
