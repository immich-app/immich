...
class SystemConfigDto {
  ...
  @override
  String toString() => 'SystemConfigDto[ffmpeg=$ffmpeg, oauth=$oauth, passwordLogin=$passwordLogin, storageTemplate=$storageTemplate, display=$display]';
  ...
  static SystemConfigDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SystemConfigDto(
        ...
        display: SystemConfigDisplayDto.fromJson(json[r'display'])!,
      );
    }
    return null;
  }
