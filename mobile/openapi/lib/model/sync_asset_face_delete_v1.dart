...
class SyncAssetFaceDeleteV1 {
  ...
  static SyncAssetFaceDeleteV1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'assetFaceId'), 'Required key "SyncAssetFaceDeleteV1[assetFaceId]" is missing from JSON.');
        assert(json[r'assetFaceId'] != null, 'Required key "SyncAssetFaceDeleteV1[assetFaceId]" has a null value in JSON.');
        return true;
      }());
