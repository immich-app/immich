...
class WorkflowTriggerResponseDto {
  ...
  static WorkflowTriggerResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'trigger'), 'Required key "WorkflowTriggerResponseDto[trigger]" is missing from JSON.');
        assert(json[r'trigger'] != null, 'Required key "WorkflowTriggerResponseDto[trigger]" has a null value in JSON.');
        assert(json.containsKey(r'types'), 'Required key "WorkflowTriggerResponseDto[types]" is missing from JSON.');
        assert(json[r'types'] != null, 'Required key "WorkflowTriggerResponseDto[types]" has a null value in JSON.');
        return true;
      }());
