...
class SharedLinksUpdate {
  ...
  bool operator ==(Object other) =>
      ...
      other is SharedLinksUpdate && other.enabled == enabled && other.sidebarWeb == sidebarWeb;
  ...
  static List<SharedLinksUpdate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SharedLinksUpdate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SharedLinksUpdate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
