...
final class SharedLinksUpdate {
  const SharedLinksUpdate({this.enabled, this.sidebarWeb});
  ...
  static SharedLinksUpdate? fromJson(dynamic value) {
    ApiCompat.upgrade<SharedLinksUpdate>(value);
  ...
  SharedLinksUpdate copyWith({Object? enabled = _undefined, Object? sidebarWeb = _undefined}) {
    return .new(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is SharedLinksUpdate && enabled == other.enabled && sidebarWeb == other.sidebarWeb);
  }
