...
class SystemConfigNewVersionCheckDto {
  ...
  static SystemConfigNewVersionCheckDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'channel'), 'Required key "SystemConfigNewVersionCheckDto[channel]" is missing from JSON.');
        assert(json[r'channel'] != null, 'Required key "SystemConfigNewVersionCheckDto[channel]" has a null value in JSON.');
