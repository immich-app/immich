...
class PeopleUpdate {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is PeopleUpdate && other.enabled == enabled && other.sidebarWeb == sidebarWeb;
  ...
  static List<PeopleUpdate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PeopleUpdate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PeopleUpdate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
