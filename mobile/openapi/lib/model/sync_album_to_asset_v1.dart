...
final class SyncAlbumToAssetV1 {
  const SyncAlbumToAssetV1({required this.albumId, required this.assetId});
  ...
  static SyncAlbumToAssetV1? fromJson(dynamic value) {
    ApiCompat.upgrade<SyncAlbumToAssetV1>(value);
  ...
  SyncAlbumToAssetV1 copyWith({String? albumId, String? assetId}) {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is SyncAlbumToAssetV1 && albumId == other.albumId && assetId == other.assetId);
  }
