...
class SystemConfigPasswordLoginDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is SystemConfigPasswordLoginDto && other.enabled == enabled;
  ...
  static List<SystemConfigPasswordLoginDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SystemConfigPasswordLoginDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SystemConfigPasswordLoginDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
