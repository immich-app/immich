...
class CheckExistingAssetsResponseDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is CheckExistingAssetsResponseDto && _deepEquality.equals(other.existingIds, existingIds);
  ...
  static List<CheckExistingAssetsResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CheckExistingAssetsResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CheckExistingAssetsResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
