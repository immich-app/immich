...
class OnboardingResponseDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is OnboardingResponseDto && other.isOnboarded == isOnboarded;
  ...
  static List<OnboardingResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<OnboardingResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = OnboardingResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
