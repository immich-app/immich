...
final class PluginTemplateStepResponseDto {
  const PluginTemplateStepResponseDto({required this.config, this.enabled, required this.method});
  ...
  static PluginTemplateStepResponseDto? fromJson(dynamic value) {
    ApiCompat.upgrade<PluginTemplateStepResponseDto>(value);
  ...
  PluginTemplateStepResponseDto copyWith({Object? config = _undefined, Object? enabled = _undefined, String? method}) {
    return .new(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is PluginTemplateStepResponseDto &&
