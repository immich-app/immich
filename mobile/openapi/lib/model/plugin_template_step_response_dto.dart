...
class PluginTemplateStepResponseDto {
  ...
  static PluginTemplateStepResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'config'), 'Required key "PluginTemplateStepResponseDto[config]" is missing from JSON.');
        assert(json.containsKey(r'method'), 'Required key "PluginTemplateStepResponseDto[method]" is missing from JSON.');
        assert(json[r'method'] != null, 'Required key "PluginTemplateStepResponseDto[method]" has a null value in JSON.');
        return true;
      }());
