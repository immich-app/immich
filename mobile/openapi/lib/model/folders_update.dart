...
class FoldersUpdate {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is FoldersUpdate && other.enabled == enabled && other.sidebarWeb == sidebarWeb;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (enabled == null ? 0 : enabled!.hashCode) + (sidebarWeb == null ? 0 : sidebarWeb!.hashCode);
  ...
  static List<FoldersUpdate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<FoldersUpdate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = FoldersUpdate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
