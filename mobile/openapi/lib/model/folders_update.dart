...
final class FoldersUpdate {
  const FoldersUpdate({this.enabled, this.sidebarWeb});
  ...
  static FoldersUpdate? fromJson(dynamic value) {
    ApiCompat.upgrade<FoldersUpdate>(value);
  ...
  FoldersUpdate copyWith({Object? enabled = _undefined, Object? sidebarWeb = _undefined}) {
    return .new(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is FoldersUpdate && enabled == other.enabled && sidebarWeb == other.sidebarWeb);
  }
