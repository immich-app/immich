...
class TestEmailResponseDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is TestEmailResponseDto && other.messageId == messageId;
  ...
  static List<TestEmailResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<TestEmailResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = TestEmailResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
