...
class HybridSearchDto {
  /// Returns a new [HybridSearchDto] instance.
  HybridSearchDto({
    this.city,
    this.context,
    this.country,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HybridSearchDto &&
    other.city == city &&
  ...
  /// Returns a new [HybridSearchDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HybridSearchDto? fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();

      return HybridSearchDto(
  ...
  static List<HybridSearchDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HybridSearchDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HybridSearchDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HybridSearchDto> mapFromJson(dynamic json) {
    final map = <String, HybridSearchDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HybridSearchDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HybridSearchDto-objects as value to a dart map
  static Map<String, List<HybridSearchDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HybridSearchDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HybridSearchDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
