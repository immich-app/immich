...
class OnboardingDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is OnboardingDto && other.isOnboarded == isOnboarded;
  ...
  static List<OnboardingDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<OnboardingDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = OnboardingDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
