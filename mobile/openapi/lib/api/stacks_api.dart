...
class StacksApi {
  ...
  ///
  /// * [String] id (required):
  Future<bool?> deleteStack(String id,) async {
  ...
  ///
  /// * [BulkIdsDto] bulkIdsDto (required):
  Future<bool?> deleteStacks(BulkIdsDto bulkIdsDto,) async {
  ...
  ///
  /// * [String] id (required):
  Future<bool?> removeAssetFromStack(String assetId, String id,) async {
