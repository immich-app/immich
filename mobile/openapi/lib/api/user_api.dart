...
class UserApi {
  ...
  /// Performs an HTTP 'POST /user/partner/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> addPartnerWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/user/partner/{id}'
      .replaceAll('{id}', id);
  ...
  /// Performs an HTTP 'GET /user/partner' operation and returns the [Response].
  Future<Response> getAllPartnersWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/user/partner';
  ...
  /// Performs an HTTP 'DELETE /user/partner/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
