...
class AssetApi {
  ...
  /// Performs an HTTP 'GET /asset/full-sync' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [num] limit (required):
  ///
  ...
  ///
  /// * [String] userId:
  Future<Response> getAllForUserFullSyncWithHttpInfo(num limit, DateTime updatedUntil, { DateTime? lastCreationDate, String? lastId, String? userId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/full-sync';
  ...
  /// Performs an HTTP 'GET /asset/delta-sync' operation and returns the [Response].
  /// Parameters:
  ///
