...
class AssetApi {
  ...
  /// Performs an HTTP 'DELETE /asset/upload-tus/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  ///
  /// * [String] key:
  Future<Response> uploadFileTusDeleteWithHttpInfo(String id, { String? key, }) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/upload-tus/{id}'
      .replaceAll('{id}', id);
  ...
  Future<Object?> uploadFileTusDelete(String id, { String? key, }) async {
    final response = await uploadFileTusDeleteWithHttpInfo(id,  key: key, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'HEAD /asset/upload-tus/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  ///
  /// * [String] key:
  Future<Response> uploadFileTusHeadWithHttpInfo(String id, { String? key, }) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/upload-tus/{id}'
      .replaceAll('{id}', id);
  ...
  Future<Object?> uploadFileTusHead(String id, { String? key, }) async {
    final response = await uploadFileTusHeadWithHttpInfo(id,  key: key, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'PATCH /asset/upload-tus/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  ///
  /// * [String] key:
  Future<Response> uploadFileTusPatchWithHttpInfo(String id, { String? key, }) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/upload-tus/{id}'
      .replaceAll('{id}', id);
  ...
  Future<Object?> uploadFileTusPatch(String id, { String? key, }) async {
    final response = await uploadFileTusPatchWithHttpInfo(id,  key: key, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'POST /asset/upload-tus' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] key:
  Future<Response> uploadFileTusPostWithHttpInfo({ String? key, }) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/upload-tus';
  ...
  Future<Object?> uploadFileTusPost({ String? key, }) async {
    final response = await uploadFileTusPostWithHttpInfo( key: key, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
