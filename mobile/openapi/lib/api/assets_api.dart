...
class AssetsApi {
  ...
  /// Performs an HTTP 'PUT /assets/stack' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [AssetBulkStackDto] assetBulkStackDto (required):
  Future<Response> stackAssetsWithHttpInfo(AssetBulkStackDto assetBulkStackDto,) async {
    // ignore: prefer_const_declarations
    final path = r'/assets/stack';

    // ignore: prefer_final_locals
    Object? postBody = assetBulkStackDto;
  ...
  ///
  /// * [AssetBulkStackDto] assetBulkStackDto (required):
  Future<void> stackAssets(AssetBulkStackDto assetBulkStackDto,) async {
    final response = await stackAssetsWithHttpInfo(assetBulkStackDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }

  /// Performs an HTTP 'DELETE /assets/stack' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [AssetStackDto] assetStackDto (required):
  Future<Response> unstackAssetsWithHttpInfo(AssetStackDto assetStackDto,) async {
    // ignore: prefer_const_declarations
    final path = r'/assets/stack';

    // ignore: prefer_final_locals
    Object? postBody = assetStackDto;
  ...
  ///
  /// * [AssetStackDto] assetStackDto (required):
  Future<void> unstackAssets(AssetStackDto assetStackDto,) async {
    final response = await unstackAssetsWithHttpInfo(assetStackDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
