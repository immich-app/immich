...
class LibraryApi {
  ...
  /// Performs an HTTP 'GET /library/{id}/excludePatterns' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> getExcludePatternWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/library/{id}/excludePatterns'
      .replaceAll('{id}', id);
  ...
  Future<List<String>?> getExcludePattern(String id,) async {
    final response = await getExcludePatternWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'POST /library/{id}/excludePatterns' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  ///
  /// * [SetExcludePatternsDto] setExcludePatternsDto (required):
  Future<Response> setExcludePatternsWithHttpInfo(String id, SetExcludePatternsDto setExcludePatternsDto,) async {
    // ignore: prefer_const_declarations
    final path = r'/library/{id}/excludePatterns'
      .replaceAll('{id}', id);

    // ignore: prefer_final_locals
    Object? postBody = setExcludePatternsDto;
  ...
  Future<LibraryResponseDto?> setExcludePatterns(String id, SetExcludePatternsDto setExcludePatternsDto,) async {
    final response = await setExcludePatternsWithHttpInfo(id, setExcludePatternsDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
