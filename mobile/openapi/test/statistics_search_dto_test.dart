...
// tests for StatisticsSearchDto
void main() {
  // final instance = StatisticsSearchDto();

  group('test StatisticsSearchDto', () {
    // Filter by album IDs
    // Optional<List<String>?> albumIds (default value: const [])
    test('to test the property `albumIds`', () async {
      // TODO
    });
    ...
    // Optional<List<String>?> personIds (default value: const [])
    ...
    // Filter by tag IDs
    // Optional<List<String>?> tagIds (default value: const [])
