...
// tests for InspectedLocalRepositoryDto
void main() {
  // final instance = InspectedLocalRepositoryDto();

  group('test InspectedLocalRepositoryDto', () {
    // Optional<RepositoryBackendsDto?> backends
    test('to test the property `backends`', () async {
      // TODO
    });
    ...
    // List<SnapshotDto> snapshots (default value: const [])
    test('to test the property `snapshots`', () async {
      // TODO
    });

    // bool worm
    test('to test the property `worm`', () async {
      // TODO
    });
