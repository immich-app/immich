...
func buildEntry(api: ImmichAPI, asset: SearchResult, hourOffset: Int, subtitle: String? = nil)
...
func generateRandomEntries(api: ImmichAPI, now: Date, count: Int, albumId: String? = nil)
  async throws -> [ImageEntry]
{
