 ...
 * List all albums
 */
export declare function getAllAlbums({ assetId, isOwned, isShared }: {
    assetId?: string;
    isOwned?: boolean;
    isShared?: boolean;
...
export declare function oidcDeviceFlow(opts?: Oazapfts.RequestOpts): Promise<DeviceFlowResponseDto>;
export declare function getBackends(opts?: Oazapfts.RequestOpts): Promise<BackendsResponseDto>;
export declare function createLocalBackend({ createLocalBackendRequestDto }: {
    createLocalBackendRequestDto: CreateLocalBackendRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<BackendResponseDto>;
...
export declare function configureImmichIntegration({ configureImmichIntegrationRequestDto }: {
    configureImmichIntegrationRequestDto: ConfigureImmichIntegrationRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<never>;
export declare function getRun({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<RunResponseDto>;
export declare function logStreamSse({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<never>;
...
export declare function importRecoveryKey({ importRecoveryKeyRequest }: {
...
export declare function createRepository({ backend, repositoryCreateRequestDto }: {
    backend?: string;
    repositoryCreateRequestDto: RepositoryCreateRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<RepositoryCreateResponseDto>;
export declare function inspectRepositories(opts?: Oazapfts.RequestOpts): Promise<RepositoryInspectResponseDto>;
export declare function deleteRepository({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<never>;
export declare function updateRepository({ backend, id, repositoryUpdateRequestDto }: {
    backend?: string;
    id: string;
    repositoryUpdateRequestDto: RepositoryUpdateRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<RepositoryUpdateResponseDto>;
export declare function createBackup({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<LogResponseDto>;
export declare function checkImportRepository({ backend, id }: {
    backend: string;
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<RepositoryCheckImportResponseDto>;
export declare function importRepository({ backend, id }: {
    backend: string;
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<RepositoryCreateResponseDto>;
export declare function getRunHistory({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<RunHistoryResponseDto>;
export declare function getSnapshots({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<ListSnapshotsResponseDto>;
export declare function pruneRepository({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<LogResponseDto>;
export declare function forgetSnapshot({ id, snapshot }: {
    id: string;
    snapshot: string;
}, opts?: Oazapfts.RequestOpts): Promise<ListSnapshotsResponseDto>;
export declare function restoreSnapshot({ id, snapshot, repositorySnapshotRestoreRequestDto }: {
    id: string;
    snapshot: string;
    repositorySnapshotRestoreRequestDto: RepositorySnapshotRestoreRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<LogResponseDto>;
export declare function getSnapshotListing({ id, path, snapshot }: {
    id: string;
    path?: string;
    snapshot: string;
}, opts?: Oazapfts.RequestOpts): Promise<FilesystemListingResponseDto>;
export declare function restoreFromPoint({ backend, id, snapshot, repositorySnapshotRestoreFromPointRequestDto }: {
    backend: string;
    id: string;
    snapshot: string;
    repositorySnapshotRestoreFromPointRequestDto: RepositorySnapshotRestoreFromPointRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<LogResponseDto>;
export declare function getSchedules(opts?: Oazapfts.RequestOpts): Promise<ScheduleListResponseDto>;
export declare function createSchedule({ scheduleCreateRequestDto }: {
    scheduleCreateRequestDto: ScheduleCreateRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<ScheduleCreateResponseDto>;
export declare function removeSchedule({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts): Promise<never>;
export declare function updateSchedule({ id, scheduleUpdateRequestDto }: {
    id: string;
    scheduleUpdateRequestDto: ScheduleUpdateRequestDto;
}, opts?: Oazapfts.RequestOpts): Promise<ScheduleUpdateResponseDto>;
export declare function getRunningTasks(opts?: Oazapfts.RequestOpts): Promise<RunningTaskListResponse>;
export declare function cancelTask({ parentId }: {
    parentId: string;
}, opts?: Oazapfts.RequestOpts): Promise<never>;
