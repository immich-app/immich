 ...
 * List all albums
 */
export function getAllAlbums({ assetId, isOwned, isShared }, opts) {
...
export function oidcDeviceFlow(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/auth/oidc/device", {
        ...opts
    }));
}
export function getBackends(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/backend", {
        ...opts
    }));
}
export function createLocalBackend({ createLocalBackendRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/backend/local", oazapfts.json({
        ...opts,
        method: "POST",
...
export function getFileListing({ path }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/fs${QS.query(QS.explode({
        path
    }))}`, {
        ...opts
    }));
...
export function getIntegrations(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/integrations", {
        ...opts
    }));
}
...
export function getRun({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/logs/${encodeURIComponent(id)}`, {
        ...opts
    }));
}
...
export function onboardingStatus(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/onboarding", {
        ...opts
    }));
}
export function currentRecoveryKey(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/onboarding/recovery-key", {
        ...opts
    }));
}
export function confirmRecoveryKey(opts) {
    return oazapfts.ok(oazapfts.fetchText("/yucca/onboarding/recovery-key", {
        ...opts,
        method: "POST"
    }));
}
export function importRecoveryKey({ importRecoveryKeyRequest }, opts) {
...
export function skipOnboardingExtraConfig(opts) {
    return oazapfts.ok(oazapfts.fetchText("/yucca/onboarding/skip", {
        ...opts,
        method: "POST"
    }));
}
export function getRepositories(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/repository", {
        ...opts
    }));
}
export function createRepository({ backend, repositoryCreateRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository${QS.query(QS.explode({
        backend
    }))}`, oazapfts.json({
        ...opts,
        method: "POST",
...
export function inspectRepositories(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/repository/inspect", {
        ...opts
    }));
}
export function deleteRepository({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchText(`/yucca/repository/${encodeURIComponent(id)}`, {
        ...opts,
        method: "DELETE"
    }));
}
export function updateRepository({ backend, id, repositoryUpdateRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}${QS.query(QS.explode({
        backend
    }))}`, oazapfts.json({
        ...opts,
        method: "PATCH",
...
export function createBackup({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}`, {
        ...opts,
        method: "POST"
    }));
}
export function checkImportRepository({ backend, id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/import${QS.query(QS.explode({
        backend
    }))}`, {
        ...opts
    }));
}
export function importRepository({ backend, id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/import${QS.query(QS.explode({
        backend
    }))}`, {
        ...opts,
...
export function getRunHistory({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/runs`, {
        ...opts
    }));
}
export function getSnapshots({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/snapshots`, {
        ...opts
    }));
}
export function pruneRepository({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/snapshots/prune`, {
        ...opts,
        method: "POST"
    }));
}
export function forgetSnapshot({ id, snapshot }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/snapshots/${encodeURIComponent(snapshot)}`, {
        ...opts,
        method: "DELETE"
    }));
}
export function restoreSnapshot({ id, snapshot, repositorySnapshotRestoreRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/snapshots/${encodeURIComponent(snapshot)}`, oazapfts.json({
        ...opts,
        method: "POST",
        body: repositorySnapshotRestoreRequestDto
    })));
}
export function getSnapshotListing({ id, path, snapshot }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/snapshots/${encodeURIComponent(snapshot)}/listing${QS.query(QS.explode({
        path
    }))}`, {
        ...opts
    }));
}
export function restoreFromPoint({ backend, id, snapshot, repositorySnapshotRestoreFromPointRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/repository/${encodeURIComponent(id)}/snapshots/${encodeURIComponent(snapshot)}/restore-from-point${QS.query(QS.explode({
        backend
    }))}`, oazapfts.json({
        ...opts,
        method: "POST",
...
export function getSchedules(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/schedule", {
        ...opts
    }));
}
export function createSchedule({ scheduleCreateRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/schedule", oazapfts.json({
        ...opts,
        method: "POST",
        body: scheduleCreateRequestDto
    })));
}
export function removeSchedule({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchText(`/yucca/schedule/${encodeURIComponent(id)}`, {
        ...opts,
        method: "DELETE"
    }));
}
export function updateSchedule({ id, scheduleUpdateRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/yucca/schedule/${encodeURIComponent(id)}`, oazapfts.json({
        ...opts,
        method: "PATCH",
        body: scheduleUpdateRequestDto
    })));
}
export function getRunningTasks(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/yucca/tasks", {
        ...opts
    }));
}
export function cancelTask({ parentId }, opts) {
