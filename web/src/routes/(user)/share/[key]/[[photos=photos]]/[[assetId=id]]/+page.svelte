...
{#if passwordRequired}
  ...
  <main
    class="relative h-dvh overflow-hidden bg-immich-bg px-6 max-md:mt-[var(--navbar-height-md)] mt-[var(--navbar-height)] dark:bg-immich-dark-bg sm:px-12 md:px-24 lg:px-40"
  >
