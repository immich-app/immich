      ...
      <Card expandable expanded={false}>
        <CardHeader class="bg-indigo-50 dark:bg-primary/20">
          <div class="flex items-start gap-3">
            ...
            <div class="flex flex-col">
              <CardTitle class="text-left text-primary">When</CardTitle>
              <CardDescription>A trigger that kick off the workflow</CardDescription>
            </div>
          </div>
        </CardHeader>
      ...
      <Card expandable expanded={false}>
        <CardHeader class="bg-amber-50 dark:bg-[#5e4100]">
          <div class="flex items-start gap-3">
            ...
            <div class="flex flex-col">
              <CardTitle class="text-left text-warning">What</CardTitle>
        ...
        <CardBody>
          {#each supportFilters as filter (filter.id)}
            <div class="grid grid-cols-2 gap-4">{filter.title}</div>
          {/each}
        </CardBody>
      </Card>
      ...
      <Card expandable expanded={false}>
        ...
        <CardBody>
          {#each supportActions as action (action.id)}
            <div class="grid grid-cols-2 gap-4">{action.title}</div>
          {/each}
        </CardBody>
      </Card>
    </VStack>
