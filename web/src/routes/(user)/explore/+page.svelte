<script lang="ts">
  ...
  import ClockOutline from 'svelte-material-icons/icons/ClockOutline.svelte';
  import HeartMultipleOutline from 'svelte-material-icons/icons/HeartMultipleOutline.svelte';
  import MotionPlayOutline from 'svelte-material-icons/icons/MotionPlayOutline.svelte';
