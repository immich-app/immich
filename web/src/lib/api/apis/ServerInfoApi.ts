...
import type { ServerInfoResponseDto, ServerPingResponse, ServerVersionReponseDto } from '../models';
import {
...
export class ServerInfoApi extends runtime.BaseAPI {
	/**
	 */
	async serverInfoControllerGetServerInfoRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<ServerInfoResponseDto>> {
	...
	/**
	 */
	async serverInfoControllerGetServerInfo(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	/**
	 */
	async serverInfoControllerGetServerPulseRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<ServerPingResponse>> {
		const queryParameters: any = {};
	...
	/**
	 */
	async serverInfoControllerGetServerPulse(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	/**
	 */
	async serverInfoControllerGetServerVersionRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<ServerVersionReponseDto>> {
		const queryParameters: any = {};
	...
	/**
	 */
	async serverInfoControllerGetServerVersion(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<ServerVersionReponseDto> {
