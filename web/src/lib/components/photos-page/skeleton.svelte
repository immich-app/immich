...
<div class="overflow-clip" style:height={height + 'px'}>
  <div
    class="flex pt-7 pb-5 h-6 place-items-center text-xs font-medium text-immich-fg bg-immich-bg dark:bg-immich-dark-bg dark:text-immich-dark-fg md:text-sm"
  >
    {title}
  </div>
  <div
