<script lang="ts">
  ...
  import { api } from '@api';
  import HeartMinusOutline from 'immich-material-icons/icons/HeartMinusOutline.svelte';
  import HeartOutline from 'immich-material-icons/icons/HeartOutline.svelte';
