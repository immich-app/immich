<script lang="ts">
  ...
  import Calendar from 'svelte-material-icons/icons/Calendar.svelte';
  import CameraIris from 'svelte-material-icons/icons/CameraIris.svelte';
  import Close from 'svelte-material-icons/icons/Close.svelte';
  import ImageOutline from 'svelte-material-icons/icons/ImageOutline.svelte';
  import MapMarkerOutline from 'svelte-material-icons/icons/MapMarkerOutline.svelte';
