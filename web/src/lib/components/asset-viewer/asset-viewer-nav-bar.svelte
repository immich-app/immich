<script lang="ts">
  ...
  import MagnifyPlusOutline from 'immich-material-icons/icons/MagnifyPlusOutline.svelte';
  import MagnifyMinusOutline from 'immich-material-icons/icons/MagnifyMinusOutline.svelte';
