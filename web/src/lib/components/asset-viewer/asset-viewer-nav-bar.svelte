<script lang="ts">
  ...
  import Heart from 'svelte-material-icons/icons/Heart.svelte';
  ...
  import MagnifyPlusOutline from 'svelte-material-icons/icons/MagnifyPlusOutline.svelte';
  import MagnifyMinusOutline from 'svelte-material-icons/icons/MagnifyMinusOutline.svelte';
  import MotionPauseOutline from 'svelte-material-icons/icons/MotionPauseOutline.svelte';
