<script lang="ts">
  import { appStoreBadge, fdroidBadge, playStoreBadge } from '@immich/ui';
  // import { t } from 'svelte-i18n';
</script>

<!-- This should probably be redone. I considered removing the labels since the badges are all that's needed. -->
