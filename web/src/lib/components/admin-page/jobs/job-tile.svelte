...
<div class="flex flex-col">
	...
	{/if}
	<div
		class="flex justify-between bg-gray-100 dark:bg-immich-dark-gray"
		class:rounded-3xl={isIdle}
		class:rounded-b-3xl={!isIdle}
	>
		...
		<div
			class="flex flex-col w-32 overflow-hidden"
			class:rounded-r-3xl={isIdle}
			class:rounded-br-3xl={!isIdle}
		>
			{#if !isIdle}
				{#if waitingCount > 0}
					<JobTileButton
