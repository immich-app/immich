<script lang="ts">
  ...
  import type Icon from 'svelte-material-icons/icons/DotsVertical.svelte';
  import FaceRecognition from 'svelte-material-icons/icons/FaceRecognition.svelte';
  import FileJpgBox from 'svelte-material-icons/icons/FileJpgBox.svelte';
  import FileXmlBox from 'svelte-material-icons/icons/FileXmlBox.svelte';
  import FolderMove from 'svelte-material-icons/icons/FolderMove.svelte';
  import CogIcon from 'svelte-material-icons/icons/Cog.svelte';
  import Table from 'svelte-material-icons/icons/Table.svelte';
  import TagMultiple from 'svelte-material-icons/icons/TagMultiple.svelte';
  import VectorCircle from 'svelte-material-icons/icons/VectorCircle.svelte';
  import Video from 'svelte-material-icons/icons/Video.svelte';
