<script lang="ts">
  ...
  import type Icon from 'immich-material-icons/icons/DotsVertical.svelte';
  import FaceRecognition from 'immich-material-icons/icons/FaceRecognition.svelte';
  import FileJpgBox from 'immich-material-icons/icons/FileJpgBox.svelte';
  import FileXmlBox from 'immich-material-icons/icons/FileXmlBox.svelte';
  import FolderMove from 'immich-material-icons/icons/FolderMove.svelte';
  import CogIcon from 'immich-material-icons/icons/Cog.svelte';
  import Table from 'immich-material-icons/icons/Table.svelte';
  import TagMultiple from 'immich-material-icons/icons/TagMultiple.svelte';
  import VectorCircle from 'immich-material-icons/icons/VectorCircle.svelte';
  import Video from 'immich-material-icons/icons/Video.svelte';
