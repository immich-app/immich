<script lang="ts">
  ...
  import CloudUploadOutline from 'immich-material-icons/icons/CloudUploadOutline.svelte';
  import WindowMinimize from 'immich-material-icons/icons/WindowMinimize.svelte';
