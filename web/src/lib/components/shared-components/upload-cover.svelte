...
<div
	...
	class="fixed inset-0 w-full h-full z-[1000] flex flex-col items-center justify-center bg-immich-bg dark:bg-immich-dark-bg text-immich-dark-gray dark:text-immich-gray"
>
	<img
		src="/immich-logo.svg"
		alt="immich logo"
