...
<div class="m-auto w-3/4 text-center flex flex-col place-content-center place-items-center mb-6 dark:text-white">
  ...
  <p class="text-4xl mt-8 font-bold">Your license has been successfully activated</p>
  <p class="text-lg mt-6">Thank you for supporting Immich and open-source software</p>
