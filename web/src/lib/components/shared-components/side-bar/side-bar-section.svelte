...
<nav
  ...
  tabindex="-1"
  class="immich-scrollbar h-full relative w-0 sidebar:w-[16rem] overflow-y-auto overflow-x-hidden bg-immich-bg pt-8 transition-all duration-200 dark:bg-immich-dark-bg"
