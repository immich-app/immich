<script lang="ts">
  ...
  import { api } from '@api';
  import AccountMultipleOutline from 'svelte-material-icons/icons/AccountMultipleOutline.svelte';
  import AccountMultiple from 'svelte-material-icons/icons/AccountMultiple.svelte';
  import ImageAlbum from 'svelte-material-icons/icons/ImageAlbum.svelte';
  import ImageMultipleOutline from 'svelte-material-icons/icons/ImageMultipleOutline.svelte';
  import ImageMultiple from 'svelte-material-icons/icons/ImageMultiple.svelte';
  import ArchiveArrowDownOutline from 'svelte-material-icons/icons/ArchiveArrowDownOutline.svelte';
  import Magnify from 'svelte-material-icons/icons/Magnify.svelte';
  import Map from 'svelte-material-icons/icons/Map.svelte';
  import HeartMultipleOutline from 'svelte-material-icons/icons/HeartMultipleOutline.svelte';
  import HeartMultiple from 'svelte-material-icons/icons/HeartMultiple.svelte';
