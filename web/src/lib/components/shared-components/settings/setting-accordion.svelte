...
<div
  class={`border rounded-2xl my-4 px-6 py-4 transition-all ${isOpen ? 'border-immich-primary/40 dark:border-immich-dark-primary/50 shadow-lg' : 'dark:border-gray-800'}`}
  ...
  >
    <div>
      <div class="flex gap-2 place-items-center">
        {#if icon}
          <Icon path={icon} class="text-immich-primary dark:text-immich-dark-primary" size="24" />
        {/if}
