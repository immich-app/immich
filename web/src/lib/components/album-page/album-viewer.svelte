...
<main
  class="relative h-dvh overflow-hidden bg-immich-bg px-2 md:px-6 max-md:mt-[var(--navbar-height-md)] mt-[var(--navbar-height)] dark:bg-immich-dark-bg"
>
  <AssetGrid enableRouting={true} {album} {assetStore} {assetInteraction}>
    <section class="mt-8 md:mt-24 px-2 md:px-0">
      <!-- ALBUM TITLE -->
      <h1
