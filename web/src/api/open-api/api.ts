...
export class AlbumApi extends BaseAPI {
  ...
  public addAssetsToAlbum(requestParameters: AlbumApiAddAssetsToAlbumRequest, options?: AxiosRequestConfig) {
    return AlbumApiFp(this.configuration)
      .addAssetsToAlbum(requestParameters.id, requestParameters.addAssetsDto, requestParameters.key, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const AssetApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {boolean} isFavorite
     * @param {ProjectionTypeEnum} projectionType
     * @param {string} [key]
    ...
    uploadFile: async (
      ...
      // verify required parameter 'projectionType' is not null or undefined
      assertParamExists('uploadFile', 'projectionType', projectionType);
      ...
      if (projectionType !== undefined) {
        localVarFormParams.append('projectionType', projectionType as any);
      }
...
export const AssetApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async checkDuplicateAsset(
      ...
      key?: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CheckDuplicateAssetResponseDto>> {
    ...
    async deleteAsset(
      ...
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DeleteAssetResponseDto>>> {
    ...
    async getAssetCountByTimeBucket(
      getAssetCountByTimeBucketDto: GetAssetCountByTimeBucketDto,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AssetCountByTimeBucketResponseDto>> {
    ...
    async getDownloadInfo(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDownloadInfo(
        assetIds,
        albumId,
        userId,
        archiveSize,
...
export const AssetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    getDownloadInfo(
      ...
      return localVarFp
        .getDownloadInfo(assetIds, albumId, userId, archiveSize, key, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export interface AssetApiUploadFileRequest {
   ...
   * @memberof AssetApiUploadFile
   */
  readonly projectionType: ProjectionTypeEnum;
...
export class AssetApi extends BaseAPI {
  ...
  public getAssetStats(requestParameters: AssetApiGetAssetStatsRequest = {}, options?: AxiosRequestConfig) {
    return AssetApiFp(this.configuration)
      .getAssetStats(requestParameters.isArchived, requestParameters.isFavorite, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getDownloadInfo(requestParameters: AssetApiGetDownloadInfoRequest = {}, options?: AxiosRequestConfig) {
    return AssetApiFp(this.configuration)
      .getDownloadInfo(
        requestParameters.assetIds,
        requestParameters.albumId,
        requestParameters.userId,
        requestParameters.archiveSize,
...
export const SearchApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getSearchConfig(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SearchConfigResponseDto>> {
...
export const ServerInfoApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getServerVersion(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServerVersionReponseDto>> {
...
export const SharedLinkApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    removeSharedLinkAssets(
      ...
      return localVarFp
        .removeSharedLinkAssets(id, assetIdsDto, key, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getProfileImage: async (userId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/user/profile-image/{userId}`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    getUserById: async (userId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/user/info/{userId}`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    restoreUser: async (userId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/user/{userId}/restore`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
