...
export const AssetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        uploadFile: async (assetType: AssetTypeEnum, assetData: File, fileCreatedAt: string, fileModifiedAt: string, isFavorite: boolean, fileExtension: string, key?: string, livePhotoData?: File, deviceAssetId?: string, deviceId?: string, isVisible?: boolean, duration?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AssetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadFile(assetType: AssetTypeEnum, assetData: File, fileCreatedAt: string, fileModifiedAt: string, isFavorite: boolean, fileExtension: string, key?: string, livePhotoData?: File, deviceAssetId?: string, deviceId?: string, isVisible?: boolean, duration?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AssetFileUploadResponseDto>> {
...
export const AssetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        uploadFile(assetType: AssetTypeEnum, assetData: File, fileCreatedAt: string, fileModifiedAt: string, isFavorite: boolean, fileExtension: string, key?: string, livePhotoData?: File, deviceAssetId?: string, deviceId?: string, isVisible?: boolean, duration?: string, options?: any): AxiosPromise<AssetFileUploadResponseDto> {
...
export class AssetApi extends BaseAPI {
     ...
     * @memberof AssetApi
     */
    public uploadFile(assetType: AssetTypeEnum, assetData: File, fileCreatedAt: string, fileModifiedAt: string, isFavorite: boolean, fileExtension: string, key?: string, livePhotoData?: File, deviceAssetId?: string, deviceId?: string, isVisible?: boolean, duration?: string, options?: AxiosRequestConfig) {
