...
export const AlbumApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		addAssetsToAlbum: async (
			...
			const localVarPath = `/album/{albumId}/assets`.replace(
				`{${'albumId'}}`,
		...
		addUsersToAlbum: async (
			...
			const localVarPath = `/album/{albumId}/users`.replace(
				`{${'albumId'}}`,
				encodeURIComponent(String(albumId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		deleteAlbum: async (
			...
			const localVarPath = `/album/{albumId}`.replace(
				`{${'albumId'}}`,
				encodeURIComponent(String(albumId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		downloadArchive: async (
			...
			const localVarPath = `/album/{albumId}/download`.replace(
				`{${'albumId'}}`,
				encodeURIComponent(String(albumId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AlbumApiFactory = function (
	...
	return {
		...
		addAssetsToAlbum(
			...
			return localVarFp
				.addAssetsToAlbum(albumId, addAssetsDto, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		downloadArchive(
			...
			return localVarFp
				.downloadArchive(albumId, name, skip, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getAlbumInfo(albumId: string, key?: string, options?: any): AxiosPromise<AlbumResponseDto> {
			return localVarFp
				.getAlbumInfo(albumId, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const AssetApiFactory = function (
	...
	return {
		...
		getAllAssets(
			...
			return localVarFp
				.getAllAssets(isFavorite, isArchived, skip, ifNoneMatch, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getMapMarkers(
			...
			return localVarFp
				.getMapMarkers(isFavorite, isArchived, skip, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get all asset of a device that are in the database, ID only.
