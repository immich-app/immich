...
export const AssetApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		downloadFile: async (
			...
			const localVarPath = `/asset/download/{assetId}`.replace(
				`{${'assetId'}}`,
		...
		getAssetById: async (
			...
			const localVarPath = `/asset/assetById/{assetId}`.replace(
				`{${'assetId'}}`,
				encodeURIComponent(String(assetId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getAssetThumbnail: async (
			...
			const localVarPath = `/asset/thumbnail/{assetId}`.replace(
				`{${'assetId'}}`,
				encodeURIComponent(String(assetId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		serveFile: async (
			...
			const localVarPath = `/asset/file/{assetId}`.replace(
				`{${'assetId'}}`,
				encodeURIComponent(String(assetId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AssetApiFactory = function (
	...
	return {
		...
		downloadFile(assetId: string, key?: string, options?: any): AxiosPromise<File> {
			return localVarFp
				.downloadFile(assetId, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getAllAssets(
			...
			return localVarFp
				.getAllAssets(userId, isFavorite, isArchived, skip, ifNoneMatch, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getAssetById(assetId: string, key?: string, options?: any): AxiosPromise<AssetResponseDto> {
			return localVarFp
				.getAssetById(assetId, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getAssetThumbnail(
			...
			return localVarFp
				.getAssetThumbnail(assetId, format, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		serveFile(
			...
			return localVarFp
				.serveFile(assetId, isThumb, isWeb, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Update an asset
		...
		updateAsset(
			...
			return localVarFp
				.updateAsset(assetId, updateAssetDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export class AssetApi extends BaseAPI {
	...
	public downloadFile(
		...
		return AssetApiFp(this.configuration)
			.downloadFile(requestParameters.assetId, requestParameters.key, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public getAssetById(
		...
		return AssetApiFp(this.configuration)
			.getAssetById(requestParameters.assetId, requestParameters.key, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public updateAsset(requestParameters: AssetApiUpdateAssetRequest, options?: AxiosRequestConfig) {
		return AssetApiFp(this.configuration)
			.updateAsset(requestParameters.assetId, requestParameters.updateAssetDto, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const JobApiFactory = function (
	...
	return {
		...
		sendJobCommand(
			...
			return localVarFp
				.sendJobCommand(jobId, jobCommandDto, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class JobApi extends BaseAPI {
	...
	public sendJobCommand(
		...
		return JobApiFp(this.configuration)
			.sendJobCommand(requestParameters.jobId, requestParameters.jobCommandDto, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const ShareApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async editSharedLink(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.editSharedLink(
				id,
				editSharedLinkDto,
				options
			);
...
export const ShareApiFactory = function (
	...
	return {
		...
		editSharedLink(
			...
			return localVarFp
				.editSharedLink(id, editSharedLinkDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export class ShareApi extends BaseAPI {
	 ...
	 * @memberof ShareApi
	 */
	public editSharedLink(
		requestParameters: ShareApiEditSharedLinkRequest,
		options?: AxiosRequestConfig
	) {
		return ShareApiFp(this.configuration)
			.editSharedLink(requestParameters.id, requestParameters.editSharedLinkDto, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const TagApiFactory = function (
	...
	return {
		...
		update(id: string, updateTagDto: UpdateTagDto, options?: any): AxiosPromise<TagResponseDto> {
			return localVarFp
				.update(id, updateTagDto, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class TagApi extends BaseAPI {
	...
	public create(requestParameters: TagApiCreateRequest, options?: AxiosRequestConfig) {
		return TagApiFp(this.configuration)
			.create(requestParameters.createTagDto, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	public update(requestParameters: TagApiUpdateRequest, options?: AxiosRequestConfig) {
		return TagApiFp(this.configuration)
			.update(requestParameters.id, requestParameters.updateTagDto, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
