...
export const AlbumApiFactory = function (
	...
	return {
		...
		downloadArchive(albumId: string, skip?: number, options?: any): AxiosPromise<object> {
			return localVarFp
				.downloadArchive(albumId, skip, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const AssetApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		updateAssetsInSharedLink: async (
...
export const AssetApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async updateAssetsInSharedLink(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.updateAssetsInSharedLink(
				updateAssetsToSharedLinkDto,
				options
			);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const AssetApiFactory = function (
	...
	return {
		...
		downloadFile(
			...
			return localVarFp
				.downloadFile(assetId, isThumb, isWeb, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		downloadFiles(downloadFilesDto: DownloadFilesDto, options?: any): AxiosPromise<object> {
			return localVarFp
				.downloadFiles(downloadFilesDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getAllAssets(ifNoneMatch?: string, options?: any): AxiosPromise<Array<AssetResponseDto>> {
			return localVarFp
				.getAllAssets(ifNoneMatch, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a single asset\'s information
		...
		serveFile(
			...
			return localVarFp
				.serveFile(assetId, isThumb, isWeb, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Update an asset
		...
		updateAssetsInSharedLink(
			...
			return localVarFp
				.updateAssetsInSharedLink(updateAssetsToSharedLinkDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export class AssetApi extends BaseAPI {
	 ...
	 * @memberof AssetApi
	 */
	public updateAssetsInSharedLink(
		updateAssetsToSharedLinkDto: UpdateAssetsToSharedLinkDto,
		options?: AxiosRequestConfig
	) {
		return AssetApiFp(this.configuration)
...
export const DeviceInfoApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async createDeviceInfo(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.createDeviceInfo(
				upsertDeviceInfoDto,
				options
			);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
		...
		async updateDeviceInfo(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.updateDeviceInfo(
				upsertDeviceInfoDto,
				options
			);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const DeviceInfoApiFactory = function (
	...
	return {
		...
		createDeviceInfo(
			...
			return localVarFp
				.createDeviceInfo(upsertDeviceInfoDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * @deprecated
		...
		updateDeviceInfo(
			...
			return localVarFp
				.updateDeviceInfo(upsertDeviceInfoDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const RecycleBinApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		restoreDeletedAssets: async (
			restoreAssetsDto: RestoreAssetsDto,
			options: AxiosRequestConfig = {}
		): Promise<RequestArgs> => {
...
export const RecycleBinApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async deleteRecyleBinAssets(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DeleteAssetResponseDto>>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRecyleBinAssets(
				deleteAssetDto,
				options
			);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
		 ...
		 * @throws {RequiredError}
		 */
		async getRecycleBinConfig(
			options?: AxiosRequestConfig
		): Promise<
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecycleBinConfigResponseDto>
		> {
		 ...
		 * @throws {RequiredError}
		 */
		async getRecycleBinCountByUserId(
			options?: AxiosRequestConfig
		): Promise<
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AssetCountByUserIdResponseDto>
		> {
		...
		async restoreDeletedAssets(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AssetResponseDto>>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.restoreDeletedAssets(
				restoreAssetsDto,
				options
			);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
 ...
 * @export
 */
export const RecycleBinApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance
) {
	...
	return {
		...
		deleteRecyleBinAssets(
			...
			return localVarFp
				.deleteRecyleBinAssets(deleteAssetDto, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Empty out bin for User
		...
		getRecycleBinCountByUserId(options?: any): AxiosPromise<AssetCountByUserIdResponseDto> {
			return localVarFp
				.getRecycleBinCountByUserId(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Restore deleted Assets by User
		...
		restoreDeletedAssets(
			...
			return localVarFp
				.restoreDeletedAssets(restoreAssetsDto, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class RecycleBinApi extends BaseAPI {
	...
	public deleteRecyleBinAssets(deleteAssetDto: DeleteAssetDto, options?: AxiosRequestConfig) {
		return RecycleBinApiFp(this.configuration)
			.deleteRecyleBinAssets(deleteAssetDto, options)
			.then((request) => request(this.axios, this.basePath));
	}
