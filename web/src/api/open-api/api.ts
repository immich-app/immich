...
export const AssetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        importFile: async (importAssetDto: ImportAssetDto, key?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AssetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async importFile(importAssetDto: ImportAssetDto, key?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AssetFileUploadResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.importFile(importAssetDto, key, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const AssetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        importFile(importAssetDto: ImportAssetDto, key?: string, options?: any): AxiosPromise<AssetFileUploadResponseDto> {
            return localVarFp.importFile(importAssetDto, key, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {RemoveAssetsDto} removeAssetsDto 
...
export class AssetApi extends BaseAPI {
    ...
    public importFile(requestParameters: AssetApiImportFileRequest, options?: AxiosRequestConfig) {
        return AssetApiFp(this.configuration).importFile(requestParameters.importAssetDto, requestParameters.key, options).then((request) => request(this.axios, this.basePath));
    }
