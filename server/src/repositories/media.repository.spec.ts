...
describe(MediaRepository.name, () => {
  ...
  describe('calculateImageEditDimensions', () => {
    it('should calculate correct dimensions for crop ', async () => {
      const result = sut['calculateImageEditDimensions'](
        {
          width: 1000,
          height: 1000,
        },
      ...
      expect(result).toEqual({ width: 700, height: 300 });
    });

    it('should calculate correct dimensions for rotate', async () => {
      const result90 = sut['calculateImageEditDimensions'](
        {
          width: 500,
          height: 1000,
        },
      ...
      expect(result90).toEqual({ width: 1000, height: 500 });

      const result180 = sut['calculateImageEditDimensions'](
        {
          width: 500,
          height: 1000,
        },
      ...
      expect(result180).toEqual({ width: 500, height: 1000 });

      const result270 = sut['calculateImageEditDimensions'](
        {
          width: 500,
          height: 1000,
        },
      ...
      expect(result270).toEqual({ width: 1000, height: 500 });

      const result0 = sut['calculateImageEditDimensions'](
        {
          width: 500,
          height: 1000,
        },
      ...
      expect(result0).toEqual({ width: 500, height: 1000 });
    });

    it('should return original dimensions for mirror edits', async () => {
      const resultHorizontal = sut['calculateImageEditDimensions'](
        {
          width: 800,
          height: 600,
        },
      ...
      expect(resultHorizontal).toEqual({ width: 800, height: 600 });

      const resultVertical = sut['calculateImageEditDimensions'](
        {
          width: 800,
          height: 600,
        },
      ...
      expect(resultVertical).toEqual({ width: 800, height: 600 });
    });
  });
