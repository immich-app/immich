...
export class AppService {
  ...
  async init() {
    await this.jobService.registerHandlers({
      ...
      [JobName.ASSET_MIGRATION]: (data) => this.mediaService.handleAssetMigration(data),
      [JobName.FACE_THUMBNAIL_MIGRATION]: (data) => this.facialRecognitionService.handlePersonThumbnailMigration(data),
