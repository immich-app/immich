...
const SyncAssetOcrV1Schema = z
  .object({
    ...
    x1: z.number().describe('Top-left X coordinate (normalized 0–1)'),
    y1: z.number().describe('Top-left Y coordinate (normalized 0–1)'),
    x2: z.number().describe('Top-right X coordinate (normalized 0–1)'),
    y2: z.number().describe('Top-right Y coordinate (normalized 0–1)'),
    x3: z.number().describe('Bottom-right X coordinate (normalized 0–1)'),
    y3: z.number().describe('Bottom-right Y coordinate (normalized 0–1)'),
    x4: z.number().describe('Bottom-left X coordinate (normalized 0–1)'),
    y4: z.number().describe('Bottom-left Y coordinate (normalized 0–1)'),

    boxScore: z.number().describe('Confidence score of the bounding box'),
    textScore: z.number().describe('Confidence score of the recognized text'),
