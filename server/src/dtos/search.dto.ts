...
const BaseSearchSchema = z.object({
  ...
  minAspectRatioWidth: z.coerce.number().positive().optional().describe('Filter by minimum aspect ratio width'),
  minAspectRatioHeight: z.coerce.number().positive().optional().describe('Filter by minimum aspect ratio height'),
  maxAspectRatioWidth: z.coerce.number().positive().optional().describe('Filter by maximum aspect ratio width'),
  maxAspectRatioHeight: z.coerce.number().positive().optional().describe('Filter by maximum aspect ratio height'),
