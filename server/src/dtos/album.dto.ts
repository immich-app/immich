...
import { AlbumUser, Asset, AuthSharedLink, User } from 'src/database';
...
export const mapAlbum = (entity: MapAlbumDto, withAssets: boolean = false, auth?: AuthDto): AlbumResponseDto => {
