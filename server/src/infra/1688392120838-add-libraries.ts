...
export class AddLibraries1688392120838 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "assets" ADD CONSTRAINT "UQ_owner_library_originalpath" UNIQUE ("ownerId", "libraryId", "originalPath")`);
        await queryRunner.query(`ALTER TABLE "assets" ADD CONSTRAINT "UQ_owner_library_checksum" UNIQUE ("ownerId", "libraryId", "checksum")`);
        await queryRunner.query(`ALTER TABLE "libraries" ADD CONSTRAINT "FK_0f6fc2fb195f24d19b0fb0d57c1" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
