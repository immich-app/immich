...
FROM
  (
    SELECT
      ...
      "AlbumEntity__AlbumEntity_owner"."showOnboarding" AS "AlbumEntity__AlbumEntity_owner_showOnboarding",
      ...
      "AlbumEntity__AlbumEntity_sharedUsers"."showOnboarding" AS "AlbumEntity__AlbumEntity_sharedUsers_showOnboarding",
