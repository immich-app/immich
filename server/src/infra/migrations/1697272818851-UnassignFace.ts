...
export class UnassignFace1697272818851 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE asset_faces ADD CONSTRAINT FK_xcpv88uznujgzbsvyvs4od67ui FOREIGN KEY ("personId") REFERENCES person("id") ON DELETE NO ACTION ON UPDATE NO ACTION;`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE asset_faces ADD CONSTRAINT "FK_95ad7106dd7b484275443f580f9" FOREIGN KEY ("personId") REFERENCES person("id") ON DELETE NO ACTION ON UPDATE NO ACTION;`);
