...
where
  "assets"."id" = $ 2 :: uuid
limit
  $ 3 -- AssetJobRepository.getForSidecarWriteJob
select
  "id",
  "sidecarPath",
  "originalPath",
...
where
  "assets"."id" = $ 1 :: uuid
limit
  $ 2 -- AssetJobRepository.streamForThumbnailJob
select
  "assets"."id",
  "assets"."thumbhash",
  (
...
from
  "assets"
where
  "assets"."id" = $ 1 -- AssetJobRepository.getForGenerateThumbnailJob
select
  "assets"."id",
  "assets"."isVisible",
...
where
  "assets"."id" = $ 1 -- AssetJobRepository.getForMetadataExtraction
select
  "assets"."id",
  "assets"."checksum",
...
from
  "assets"
where
  "assets"."id" = $ 1 -- AssetJobRepository.getAlbumThumbnailFiles
select
  "asset_files"."id",
  "asset_files"."path",
  "asset_files"."type"
...
where
  ...
  and "asset_files"."type" = $ 2 -- AssetJobRepository.streamForSearchDuplicates
select
  "assets"."id"
from
  "assets"
...
where
  ...
  and "job_status"."duplicatesDetectedAt" is null -- AssetJobRepository.streamForEncodeClip
select
  "assets"."id"
from
  "assets"
...
from
  "assets"
where
  "assets"."id" = $ 2 -- AssetJobRepository.getForDetectFacesJob
select
  "assets"."id",
  "assets"."isVisible",
  to_json("exif") as "exifInfo",
...
from
  ...
  inner join "exif" on "assets"."id" = "exif"."assetId"
where
  "assets"."id" = $ 2 -- AssetJobRepository.getForSyncAssets
select
  "assets"."id",
  "assets"."isOffline",
  "assets"."libraryId",
...
from
  "assets"
where
  "assets"."id" = any ($ 1 :: uuid []) -- AssetJobRepository.getForAssetDeletion
select
  "assets"."id",
  "assets"."isVisible",
  "assets"."libraryId",
...
where
  "assets"."id" = $ 2 -- AssetJobRepository.streamForVideoConversion
select
  "assets"."id"
from
  "assets"
where
  ...
  and "assets"."deletedAt" is null -- AssetJobRepository.getForVideoConversion
select
  "assets"."id",
  "assets"."ownerId",
  "assets"."originalPath",
...
where
  "assets"."id" = $ 1
  and "assets"."type" = $ 2 -- AssetJobRepository.streamForMetadataExtraction
select
  "assets"."id"
from
  "assets"
...
where
  ...
  and "assets"."isVisible" = $ 1
  and "assets"."deletedAt" is null -- AssetJobRepository.getForStorageTemplateJob
select
  "assets"."id",
  "assets"."ownerId",
  "assets"."type",
...
where
  "assets"."deletedAt" is null
  and "assets"."id" = $ 1 -- AssetJobRepository.streamForStorageTemplateJob
select
  "assets"."id",
  "assets"."ownerId",
  "assets"."type",
...
from
  ...
  inner join "exif" on "assets"."id" = "exif"."assetId"
where
  "assets"."deletedAt" is null -- AssetJobRepository.streamForDeletedJob
select
  "id",
  "isOffline"
from
  "assets"
where
  "assets"."deletedAt" <= $ 1 -- AssetJobRepository.streamForSidecar
select
  "assets"."id"
from
  "assets"
where
  ...
  and "assets"."isVisible" = $ 2 -- AssetJobRepository.streamForDetectFacesJob
select
  "assets"."id"
from
  "assets"
