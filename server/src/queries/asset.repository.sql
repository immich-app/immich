...
SELECT
  ...
  "exifInfo"."cropLeft" AS "exifInfo_cropLeft",
  "exifInfo"."cropTop" AS "exifInfo_cropTop",
  "exifInfo"."cropWidth" AS "exifInfo_cropWidth",
  "exifInfo"."cropHeight" AS "exifInfo_cropHeight"
FROM
  "assets" "entity"
