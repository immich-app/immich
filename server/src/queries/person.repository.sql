...
where
  "person"."ownerId" = $3
  and f_unaccent ("person"."name") %> f_unaccent ($4)
order by
  f_unaccent ("person"."name") <->>> f_unaccent ($5)
limit
  $6
...
from
  "asset_face"
where
  "asset_face"."assetId" in ($4)
  and "asset_face"."personGroupId" in ($5)
  and "asset_face"."deletedAt" is null
