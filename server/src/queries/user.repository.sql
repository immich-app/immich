...
-- UserRepository.get
SELECT DISTINCT
  "distinctAlias"."UserEntity_id" AS "ids_UserEntity_id"
FROM
  (
    SELECT
      ...
      "UserEntity__UserEntity_metadata"."userId" AS "UserEntity__UserEntity_metadata_userId",
      "UserEntity__UserEntity_metadata"."key" AS "UserEntity__UserEntity_metadata_key",
      "UserEntity__UserEntity_metadata"."value" AS "UserEntity__UserEntity_metadata_value"
    FROM
      "users" "UserEntity"
      LEFT JOIN "user_metadata" "UserEntity__UserEntity_metadata" ON "UserEntity__UserEntity_metadata"."userId" = "UserEntity"."id"
    WHERE
      ((("UserEntity"."id" = $1)))
