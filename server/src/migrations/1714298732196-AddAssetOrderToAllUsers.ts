...
export class AddAssetOrderToAllUsers1714298732196 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "albums_shared_users_users" ADD "order" character varying DEFAULT 'preference'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "albums_shared_users_users" DROP COLUMN "order"`);
