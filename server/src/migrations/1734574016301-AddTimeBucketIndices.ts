...
export class AddTimeBucketIndices1734574016301 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_day_of_month" ON public.assets (date_part('day', "localDateTime" at time zone 'UTC'))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_month" ON public.assets (date_part('month', "localDateTime" at time zone 'UTC'))`,
    );
  }
}
