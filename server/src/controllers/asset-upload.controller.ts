...
import { GetUploadStatusDto, Header, ResumeUploadDto, StartUploadDto, UploadOkDto } from 'src/dtos/asset-upload.dto.js';
import { type AuthDto } from 'src/dtos/auth.dto.js';
import { ImmichHeader, Permission } from 'src/enum.js';
import { Auth, Authenticated } from 'src/middleware/auth.guard.js';
import { AssetUploadService } from 'src/services/asset-upload.service.js';
import { validateSyncOrReject } from 'src/utils/request.js';
