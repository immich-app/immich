      ...
      expect(mocks.media.transcode).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          outputOptions: [
            ...
            '-update 1',
            '-v verbose',
            String.raw`-vf setpts=N,fps=12:start_time=0:eof_action=pass:round=down,thumbnail=12,select=gt(scene\,0.1)-eq(prev_selected_n\,n)+isnan(prev_selected_n)+gt(n\,20),trim=end_frame=2,reverse,scale=-2:1440:flags=lanczos+accurate_rnd+full_chroma_int:out_range=pc`,
          ],
          twoPass: false,
        }),
      );
      ...
      expect(mocks.media.transcode).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          outputOptions: [
            ...
            '-update 1',
            '-v verbose',
            String.raw`-vf setpts=N,fps=12:start_time=0:eof_action=pass:round=down,thumbnail=12,select=gt(scene\,0.1)-eq(prev_selected_n\,n)+isnan(prev_selected_n)+gt(n\,20),trim=end_frame=2,reverse,tonemapx=tonemap=hable:desat=0:p=bt709:t=bt709:m=bt709:r=pc:peak=100:format=yuv420p`,
          ],
          twoPass: false,
        }),
      );
