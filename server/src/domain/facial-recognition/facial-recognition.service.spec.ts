...
describe(FacialRecognitionService.name, () => {
  ...
  describe('handleGenerateFaceThumbnail', () => {
    ...
    it('should generate a thumbnail', async () => {
      ...
      expect(storageMock.mkdirSync).toHaveBeenCalledWith('upload/thumbs/user-id/pe/rs/on');
      ...
      expect(mediaMock.resize).toHaveBeenCalledWith(croppedFace, 'upload/thumbs/user-id/pe/rs/on/person-1.jpeg', {
        format: 'jpeg',
        size: 250,
        quality: 80,
      ...
      expect(personMock.update).toHaveBeenCalledWith({
        faceAssetId: 'asset-1',
        id: 'person-1',
        thumbnailPath: 'upload/thumbs/user-id/pe/rs/on/person-1.jpeg',
      });
    });
