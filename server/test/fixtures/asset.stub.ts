...
export const assetStub = {
  noResizePath: Object.freeze<AssetEntity>({
    ...
    previewPath: null,
    watermarkedPreviewPath: null,
    checksum: Buffer.from('file hash', 'utf8'),
    type: AssetType.IMAGE,
    thumbnailPath: '/uploads/user-id/webp/path.ext',
    watermarkedThumbnailPath: '/uploads/user-id/webp/path_watermarked.ext',
  ...
  noWebpPath: Object.freeze<AssetEntity>({
    ...
    watermarkedPreviewPath: '/uploads/user-id/thumbs/path_watermarked.jpg',
    checksum: Buffer.from('file hash', 'utf8'),
    type: AssetType.IMAGE,
    thumbnailPath: null,
    watermarkedThumbnailPath: null,
    thumbhash: Buffer.from('blablabla', 'base64'),
    encodedVideoPath: null,
    createdAt: new Date('2023-02-23T05:06:29.716Z'),
    updatedAt: new Date('2023-02-23T05:06:29.716Z'),
