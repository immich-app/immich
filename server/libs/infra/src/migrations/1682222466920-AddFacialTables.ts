...
export class AddFacialTables1682222466920 implements MigrationInterface {
    name = 'AddFacialTables1682222466920'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "asset_faces" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "assetId" uuid, "personId" uuid, CONSTRAINT "PK_6df76ab2eb6f5b57b7c2f1fc684" PRIMARY KEY ("id"))`);
