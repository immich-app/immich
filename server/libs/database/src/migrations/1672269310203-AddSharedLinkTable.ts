...
export class AddSharedLinkTable1672269310203 implements MigrationInterface {
    name = 'AddSharedLinkTable1672269310203'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shared_links" ("id" character varying NOT NULL, "description" character varying, "userId" character varying NOT NULL, "key" character varying NOT NULL, "type" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_642e2b0f619e4876e5f90a43465" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sharedlink_asset" ("assetsId" uuid NOT NULL, "sharedLinksId" character varying NOT NULL, CONSTRAINT "PK_308679978c1baf69b9c6c710ae6" PRIMARY KEY ("assetsId", "sharedLinksId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sharedlink_album" ("albumsId" uuid NOT NULL, "sharedLinksId" character varying NOT NULL, CONSTRAINT "PK_d0aaa9c7aea2d5177f2ccb1b1e4" PRIMARY KEY ("albumsId", "sharedLinksId"))`);
