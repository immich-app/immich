...
const items: Item[] = [
  {
    ...
    iconColor: 'gray',
    title: translate({ message: 'setTimeout is cursed' }),
  ...
  },
  {
    ...
    iconColor: '#DAB1DA',
    title: translate({ message: 'PostgreSQL USER is cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiRestart,
    iconColor: '#8395e3',
    title: translate({ message: 'PostgreSQL RESET is cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiRegex,
    iconColor: 'purple',
    title: translate({ message: 'Zitadel Actions are cursed' }),
    description: translate({
      message:
  ...
  },
  {
    ...
    iconColor: '#0078d4',
    title: translate({ message: 'Entra is cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiCrop,
    iconColor: 'tomato',
    title: translate({ message: 'Image dimensions in EXIF metadata are cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiCodeJson,
    iconColor: 'yellow',
    title: translate({ message: 'YAML whitespace is cursed' }),
    description: translate({ message: 'YAML whitespaces are often handled in unintuitive ways.' }),
    link: {
  ...
  },
  {
    ...
    iconColor: '#357EC7',
    title: translate({ message: 'Hidden files in Windows are cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiWrap,
    iconColor: 'gray',
    title: translate({ message: 'Carriage returns in bash scripts are cursed' }),
    description: translate({
      message: 'Git can be configured to automatically convert LF to CRLF on checkout and CRLF breaks bash scripts.',
    }),
    link: {
  ...
  },
  {
    icon: mdiLockOff,
    iconColor: 'red',
    title: translate({ message: 'Fetch inside Cloudflare Workers is cursed' }),
    description: translate({
      message:
  ...
  },
  {
    ...
    iconColor: 'gray',
    title: translate({ message: 'GPS sharing on mobile is cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiLeadPencil,
    iconColor: 'gold',
    title: translate({ message: 'PostgreSQL NOTIFY is cursed' }),
    description: translate({
      message:
  ...
  },
  {
    ...
    title: translate({ message: 'npm scripts are cursed' }),
    description: translate({
      message:
  ...
  },
  {
    ...
    iconColor: 'brown',
    title: translate({ message: '50 extra packages are cursed' }),
    description: translate({
      message:
  ...
  },
  {
    icon: mdiLockOutline,
    iconColor: 'gold',
    title: translate({ message: 'Long passwords are cursed' }),
    description: translate({
      message:
  ...
  },
  {
    ...
    title: translate({ message: 'JavaScript Date objects are cursed' }),
    description: translate({
      message: 'JavaScript date objects are 1 indexed for years and days, but 0 indexed for months.',
    }),
  ...
  },
  {
    icon: mdiSecurity,
    iconColor: 'gold',
    title: translate({ message: 'Secure contexts are cursed' }),
    description: translate({
      message: `Some web features like the clipboard API only work in "secure contexts" (ie. https or localhost)`,
    }),
    link: {
  ...
  },
  {
    icon: mdiTrashCan,
    iconColor: 'gray',
    title: translate({ message: 'TypeORM deletes are cursed' }),
    description: translate({
      message: `The remove implementation in TypeORM mutates the input, deleting the id property from the original object.`,
    }),
    link: {
...
export default function CursedKnowledgePage(): JSX.Element {
  return (
    <Layout
      title={translate({ message: 'Cursed Knowledge' })}
      description={translate({ message: "Things we wish we didn't know" })}
    >
      <section className="my-8">
        <h1 className="md:text-6xl text-center mb-10 text-immich-primary dark:text-immich-dark-primary px-2">
          <Translate>Cursed Knowledge</Translate>
        </h1>
