...
![Create Project](./img/synology/synology-container-manager-create-project.png)
...
![Set Path](./img/synology/synology-container-manager-set-path.png)
...
![start interval](./img/synology/synology-container-manager-customize-docker-compose.png)
...
![Container Details](./img/synology/synology-container-manager-container-details.png)
...
![Firewall rules](./img/synology/synology-firewall-rules.png)
