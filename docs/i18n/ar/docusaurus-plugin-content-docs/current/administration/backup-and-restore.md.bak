...
:::info
Refer to the official [postgres documentation](https://www.postgresql.org../current/backup.html) for details about backing up and restoring a postgres database.
:::
