...
Maintenance mode is used to perform administrative tasks such as restoring backups to Gallery.
...
- Open the logs for the Gallery server and look for _"🚧 Gallery is in maintenance mode, you can log in using the following URL:"_
