...
- [External Libraries](/administration/add-an-external-library): Adding your existing photo library to Immich
- [Hardware Transcoding](/administration/set-up-hardware-transcoding): Speeding up video transcoding
- [Hardware-Accelerated Machine Learning](/administration/set-up-hardware-accelerated-machine-learning): Speeding up various machine learning tasks in Immich
