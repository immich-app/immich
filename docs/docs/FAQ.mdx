...
therefore Immich has no way of knowing what the original date of the file is when files are uploaded from WhatsApp not in the order of arrival on the device. [See #3527](https://github.com/immich-app/immich/issues/3527).
