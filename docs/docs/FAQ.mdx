...
A common alternative suggestion is to offer bounties that can be collected by anyone who submits a pull request, but we don't want those either; the Zig project has [put it well](https://ziglang.org/news/bounties-damage-open-source-projects/).
