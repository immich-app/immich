...
| `MACHINE_LEARNING_MODEL_TTL_OVERRIDES__CLIP__TEXTUAL`       | Inactivity time (s) before the (textual) CLIP model is unloaded (falls back to `MACHINE_LEARNING_MODEL_TTL`)                                                  |                              | machine learning |
| `MACHINE_LEARNING_MODEL_TTL_OVERRIDES__CLIP__VISUAL`        | Inactivity time (s) before the (visual) CLIP model is unloaded (falls back to `MACHINE_LEARNING_MODEL_TTL`)                                                   |                              | machine learning |
| `MACHINE_LEARNING_MODEL_TTL_OVERRIDES__FACIAL_RECOGNITION__RECOGNITION` | Inactivity time (s) before the (recognition) facial recognition model is unloaded (falls back to `MACHINE_LEARNING_MODEL_TTL`)                  |                              | machine learning |
| `MACHINE_LEARNING_MODEL_TTL_OVERRIDES__FACIAL_RECOGNITION__DETECTION`   | Inactivity time (s) before the (detection) facial recognition model is unloaded (falls back to `MACHINE_LEARNING_MODEL_TTL`)                    |                              | machine learning |
| `MACHINE_LEARNING_MODEL_TTL_OVERRIDES__OCR__RECOGNITION`    | Inactivity time (s) before the (recognition) OCR model is unloaded (falls back to `MACHINE_LEARNING_MODEL_TTL`)                                               |                              | machine learning |
| `MACHINE_LEARNING_MODEL_TTL_OVERRIDES__OCR__DETECTION`      | Inactivity time (s) before the (detection) OCR model is unloaded (falls back to `MACHINE_LEARNING_MODEL_TTL`)                                                 |                              | machine learning |
