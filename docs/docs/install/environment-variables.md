...
| `MACHINE_LEARNING_WORKER_MAX_REQUESTS`                      | Maximum number of requests a worker will process before restarting (disabled if <= 0)                                                                        |               `0`               | machine learning |
| `MACHINE_LEARNING_WORKER_MAX_REQUESTS_JITTER`               | Upper bound of a random value added to `MACHINE_LEARNING_WORKER_MAX_REQUESTS` to stagger worker restarts                                                     |               `0`               | machine learning |
