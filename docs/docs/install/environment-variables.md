...
| `MACHINE_LEARNING_OPENVINO_FP16`                           | Execute operations in FP16 precision: increasing speed, reducing precision (applies only to OpenVINO) |             `False`             | machine learning |
