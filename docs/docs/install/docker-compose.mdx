...
It is important to follow breaking updates to avoid problems, you can see breaking changes [here](https://github.com/immich-app/immich/discussions?discussions_q=label%3Abreaking-change+sort%3Adate_created).
:::
