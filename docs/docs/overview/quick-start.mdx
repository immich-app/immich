...
Here is a quick, no-choices path to install Gallery and take it for a test drive.
...
You can select the **Job Queues** tab to see Gallery processing your photos.
...
Gallery has built-in database backups. You can refer to the
