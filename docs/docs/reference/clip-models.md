...
Contextual (smart) search is powered by [CLIP](https://openai.com/research/clip) models. This page documents the models Immich supports and how they compare, so you can pick the one that fits your hardware and the languages your users search in.

To switch to a different model, see [Change CLIP models](/administration/change-clip-models).
