...
| `IMMICH_IGNORE_MOUNT_CHECK_ERRORS`  | See [System Integrity](/concepts/system-integrity)                                                                                                                   |                              | server                   | api, microservices |
...
:::info
Information on the current workers can be found in the [Workers](/reference/workers) reference.
:::
