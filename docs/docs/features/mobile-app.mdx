...
<img src={require('./img/allow-self-signed-ssl-certificates.png').default} width='50%' title='Allow self-signed certificate on the mobile app' />

<img src={require('./img/allow-self-signed-ssl-certificates2.png').default} width='50%' title='Allow self-signed certificate on the mobile app' />
