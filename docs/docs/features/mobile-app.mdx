...
1.  **Configuration:**
    ...
    - **Keep albums:** Hold all photos and videos in the selected albums on your device, regardless of other settings. By default, `WhatsApp` [related albums](#external-app-dependencies) are selected to be kept on the device.
...
To permanently free up space, you must empty the system/gallery trash manually outside of Immich to reclaim storage faster than 30 days.
:::
