...
- MIGraphX is a new backend for AMD cards, which compiles models at runtime. To improve subsequent inferences and better performance, it requires the following environment variables to be set:
