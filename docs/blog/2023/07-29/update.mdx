...
Over the past few releases, we have add many UI improvements to the facial recognition feature to help you manage the people better, some of the highlights
...
This is useful in situation where you have multiple faces of the same person in your photos, and you want to merge them into one.
...
We have added a new multi selection behavior on the web to help you select multiple items easier. You can now select multiple items by holding the `Shift` key and click on the items you want to select a range of photos and videos.
