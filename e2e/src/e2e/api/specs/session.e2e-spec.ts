...
import { loginDto, signupDto, uuidDto } from 'src/e2e/fixtures';
import { deviceDto, errorDto } from 'src/e2e/responses';
import { app, asBearerAuth, utils } from 'src/e2e/utils';
