import { generateConsecutiveDays, generateDayAssets } from 'src/ui-tests/generators/timeline/model-objects';
import { SeededRandom, selectRandomDays } from 'src/ui-tests/generators/timeline/utils';
